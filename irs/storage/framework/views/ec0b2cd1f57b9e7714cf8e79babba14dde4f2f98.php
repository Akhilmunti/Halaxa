    ...
    <script>
      function getwithdrawmodel(op_type){
        ...
        $.ajax({
          ...
          data:{
          Employee_Id:Employee_Id,School_Id:School_Id,Intern_Id:Intern_Id,Country:Country,City:City,Start_Date:Start_Date,End_Date:End_Date,op_type:op_type,"_token":'<?php echo e(csrf_token()); ?>'}
               ,
