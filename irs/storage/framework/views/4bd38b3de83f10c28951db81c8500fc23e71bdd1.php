            ...
            <div class="panel panel-default">
              <div class="panel-body">
                ...
                <div class="row">
                  ...
                  <p class="alert <?php echo e(Session::get('alert-class', 'alert-info alert-dismissible')); ?>" id="myalertstatus"><?php echo e(Session::get('message')); ?>
...
type: "POST",
data:{"image": response, _token: '<?php echo e(csrf_token()); ?>'},
...
<script>
                function ShowState(option){
                  ...
                  $.ajax({
                    ...
                    data:{
                    Country:Country,option:option,"_token":'<?php echo e(csrf_token()); ?>'}
                         ,
              ...
              <script>
                function ShowCity(option){
                  ...
                  $.ajax({
                    ...
                    data:{
                    State:State,option:option,"_token":'<?php echo e(csrf_token()); ?>'}
                         ,
                         context: document.body
                         }
                        ).done(function(msg) {
...
<script>
                function ShowCourse(op_type){
                  ...
                  $.ajax({
                    ...
                    data:{
                    typeofeducation:typeofeducation,op_type:op_type,"_token":'<?php echo e(csrf_token()); ?>'}
                         ,
                         context: document.body
                         }
                        ).done(function(msg) {
              ...
              <script>
                function opendeditqualificationmodel(qualificationid){
                    ...
                    data:{qualificationid:qualificationid,"_token":'<?php echo e(csrf_token()); ?>'}
                         ,
                         context: document.body
                         }
                        ).done(function(msg) {
                ...
                function openjsexperienceeditmodel(experienceid){
                    ...
                    data:{experienceid:experienceid,"_token":'<?php echo e(csrf_token()); ?>'}
                         ,
                         context: document.body
                         }
                        ).done(function(msg) {
                ...
                function openjseditCertificatedetailmodel(certificateid){
                    ...
                    data:{certificateid:certificateid,"_token":'<?php echo e(csrf_token()); ?>'}
                         ,
                         context: document.body
                         }
                        ).done(function(msg) {
            ...
            <script>
                function ShowStream(op_type){
                  ...
                  $.ajax({
                    ...
                    data:{
                    typeofeducation:typeofeducation,courseName:courseName,"_token":'<?php echo e(csrf_token()); ?>'}
                         ,
                         context: document.body
                         }
                        ).done(function(msg) {
