...
<html lang="en">
    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="wrapper">
                ...
                <div id="content">
                    <div class="theme-card container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <h4 class="theme-header-text">Draft Jobs</h4>
                            </div>
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table table-borderless table-filter">
                                    ...
                                    <tbody>
                                        <?php
                                        if (count($savedjobsdata) > 0) {
                                            foreach ($savedjobsdata as $jobInfo) {
                                                ?>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <a class="table-p mr-5 text-theme no-decoration" href="<?php echo e(url('/employer/editsavedjobsposting/'.$jobInfo->id.'')); ?>">
                                                                Edit <i class="fa fa-edit ml-2"></i>
                                                            </a>
                                                            <a class="table-p mr-5 text-primary-theme no-decoration" href="#" onClick="postsavedjob('<?php echo $jobInfo->id ?>', '<?php echo $jobInfo->jobtitle ?>')">
                                                                Publish <i class="fa fa-send-o ml-2"></i>
                                                            </a>
                                                            ...
                                                            <div class="dropdown-menu table-dropdown-menu pull-left">
                                                                ...
                                                                <a class="dropdown-item" href="<?php echo e(url('/employer/clonesavedjobsposting/'.$jobInfo->id.'')); ?>">Clone</a>
            ...
            <div class="modal fade bs-active-modal-sm" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false" id="publish_model">
                <div class="modal-dialog modal-sm">
