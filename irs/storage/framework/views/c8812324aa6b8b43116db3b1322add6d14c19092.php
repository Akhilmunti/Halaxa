                ...
                <div class="right_col" role="main" >
                    <div class="">
                        <div class="">
                            ...
                            <?php //echo '<pre>'; print_r($Activejobsdata);;?>
                            <div class="row">
                                <div class="x_panel">
                                    <div class="x_content">
                                                    ...
                                                    <?php if (count($Activejobsdata) > 0) { ?>
                                                        ...
                                                        foreach ($Activejobsdata as $user7) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="<?php echo e(url('/employer/editsavedjobsposting/'.$user7->id.'')); ?>"><button type="button" class="btn btn-primary"> <i class="fa fa-edit"></i></button></a>
                                                                    <button type="button"  onClick="deactivate_jobs('<?php echo $user7->id ?>', '<?php echo $user7->jobtitle ?>')" class="btn btn-secondary" data-toggle="modal" data-target="#deactivate_model" ><i class="fa fa-eye-slash"></i></button>
