                ...
                <div class="">
                    ...
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Edit Campus Recruitement</h3>
                        </div>
                            ...
                            <div class="form-group pull-right top_search">
                                <div class="input-group">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="active">Edit Campus Recruitement</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                          ...
                          <div id = 'error'></div>
                              ...
                              <i class="ti-user"></i>               
			                            ...
			                            <li>
                                            ...
                                            <p style="margin-top: -20px;">ASSIGN SCHOOLS AND PARTNERS</p>
										</li>
			                            <li>
                              ...
                              <h3> Job Summary
                                         ...
                                         <div class="form-group  col-md-12">
                                          <label for="firstname">Job Type 
                                            ...
                                            <select name="job_type" id="job_type" class="form-control select2" style="width: 100%;" onChange="removejob_type()" required="" readonly = "">
                                              <option value="">Select Job Type</option>

                                                <?php foreach ($job_type as $jobtype) { ?>
                                                  <option value="<?php echo $jobtype->value ?>" <?php if($Jobsdata->job_type == $jobtype->value)echo "selected" ?> ><?php echo $jobtype->value ?></option>
                                               <?php } ?>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                   ...
                                                   <input type="hidden" value="EDIT_CAMPUS" Name="PAGENAME" onkeypress="return checkQuote();" id="PAGENAME" readonly="">
                                                   <input type="hidden" value="<?php echo $Jobsdata->id ?>" Name="JOBID" id="JOBID">
                                                    <input type="text" class="form-control autocomplete" name="jobtitle" id="jobtitle" value="<?php echo $Jobsdata->jobtitle ?>" required=""/>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                   ...
                                                   <textarea name="role" class="form-control"  name="editor2" rows="10" cols="80" onChange="removeerrorrr()">
                                                   </textarea>
                                                </div>
                                                ...
                                                <div class="form-group col-md-3">
                                                   ...
                                                   <select class="form-control select2" name="maxexp" id="maxexp" style="width: 100%;" onChange="removeerroemaxexp()" required="">
                                                    ...
                                                    <option value="">Select Max Experience</option>
                                                       <?php   for( $i = intval($Jobsdata->min_years); $i<=intval($Jobsdata->min_years)+9; $i++ ) { ?>
                                           ...
                                           <?php foreach ($Currency as $currency) {
                                             ...
                                             <div class="row">
                                              ...
                                              <?php   for( $i = intval($Jobsdata->rel_min_years); $i<=intval($Jobsdata->rel_min_years)+9; $i++ ) { ?>
                                      ...
                                      <input type="text"  name="jobopning" class="form-control"  id="jobopning" min="1" max="1000" onkeypress="return isOpningJob(event,this.id)" value="<?php echo $Jobsdata->number_of_vacancies ?>" placeholder="Enter No. of Job Opening" required="">
                                              ...
                                              <input type="text" class="form-control autocomplete" name="currentposition" id="currentposition" onkeypress="return checkQuote();" value="<?php echo $Jobsdata->positioncriteria ?>" required=""/>
                                     ...
                                     <?php } ?>
                                           ...
                                           <div class="row">
                                            ...
                                            <div class="row"  id="pgblock" style="display:<?php if(count($JobQualificationPG)>0){ echo 'block'; } else{ echo 'none'; }  ?> ">
                                                ...
                                                <div class="form-group  col-md-1">
                                                    <button class="btn btn-success btn-sm streem" data-toggle="tooltip" title="Add PG!" id="Add_PG" onclick="addPG()" type="button" style="margin-top:0;"><i class="fa  fa-plus-circle"></i></button>
                                                </div>
                                                </div>
                                                <div class="col-md-12">
                                           ...
                                           <?php $PGdatacounter++; } ?>
                                            ...
                                            <div class="row" id="doctorateblock"  style="display:<?php if(count($JobQualificationPG)>0){ echo 'block'; } else{ echo 'none'; }  ?> " >
                                                ...
                                                <div class="form-group col-md-1">
                                                    <button class="btn btn-success btn-sm streem" data-toggle="tooltip" title="Add Doctorate!"  id="Add_Doctorate" onclick="addDoctorate()" type="button" style="margin-top:0;"><i class="fa  fa-plus-circle"></i></button>
                                                </div>
                                                </div>
                                                <div class="col-md-12">
                              ...
                              <p>Select All</p>
                                                ...
                                                <?php
                                                    foreach ($school_info as $school) {
                                                      ...
                                                      ?>
                                                    <div class="col-sm-4">
                                                      <label class="continr"><?php /*echo array_search($school['S_Id'],$insertedPartnersarray);*/ ?>
                                                        <input type="checkbox" name="school_partners[]" id="school_partners<?php echo $i ?>"  value="<?php echo $school['S_Id'] ?>" class="myschools" <?php if(in_array($school['S_Id'],$insertedPartnersarray,TRUE)){echo "checked"; } ?>>
                                                        <div class="choice"  name="school_partners[]" id="school_partners<?php echo $i ?>"  value="<?php echo $school['S_Id'] ?>" class="myschools" data-toggle="wizard">
                                                          <input type="checkbox" name="jobb" value="Develop" >
                                                          <div class="card card-checkboxes card-hover-effect">
                    ...
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <a href="<?php echo e(url('/employer/savedjobposting')); ?>"><button type="button" class="btn btn-default pull-left"><i class="fa fa-times"> No</i></button></a>
                          <a href="<?php echo e(url('/employer/jobposting')); ?>"><button type="button" class="btn btn-success"><i class="fa fa-check"> Yes</i></button></a>
                        </div>
...
<script>
      ...
      function removeerroemaxexp(){    
        ...
        function removejob_type(){
                  document.getElementById('job_type-error').innerHTML = '';
                }
    </script>
...
console.log('divpgdata'+divpgdata+","+divpgdata.length);
...
return allbuttons;
 ...
 <script>
              function showmaxexprience(){
                ...
                var min = parseInt(minexprnc);
                var max = parseInt(minexprnc)+9;
                console.log(max);
              ...
              function showreleventmaxexp(){
                ...
                var min = parseInt(minRelExp);
                var max = parseInt(minRelExp)+9;
           ...
           //console.log(allLocationSpan);
            ...
            return false;
              ...
              // console.log(vl);
                    ...
                    data:{UGCourse:UGCourse,"_token":'<?php echo e(csrf_token()); ?>'},
                    context: document.body
                    }).done(function(msg) {
                    $('#UGStream').html(msg);
                    });
              ...
              // console.log(vl);
                    ...
                    data:{PGCourse:PGCourse,"_token":'<?php echo e(csrf_token()); ?>'},
                    context: document.body
                    }).done(function(msg) {
                    $('#PGStream').html(msg);
                    });
...
function ShowDOCTORATEStream(){
 ...
 // console.log(vl);
      $.ajax({
       ...
       data:{DoctorateCourse:DoctorateCourse,"_token":'<?php echo e(csrf_token()); ?>'},
      context: document.body
      }).done(function(msg) {
...
<script>
              ...
              // console.log(vl);
                    ...
                    data:{FunctionalArea:FunctionalArea,"_token":'<?php echo e(csrf_token()); ?>'},
                    context: document.body
                    }).done(function(msg) {
                  ...
                  var job_type=document.getElementById('job_type').value;
                    ...
                    for(var i=0;i<ug.length;i++)
                      ...
                      if(condition=='1'){
                            ...
                            data:{PAGENAME:PAGENAME,JOBID:JOBID,job_type:job_type,Jobtitle:Jobtitle,Ccmpanyname:Ccmpanyname,ug:ugarray,pg:pgarray,
                            ...
                            EmailAddress:EmailAddress,PhoneNumber:PhoneNumber,obj,condition:condition,school_partner:school_partner,jobopning:jobopning,"_token":'<?php echo e(csrf_token()); ?>'},
                            context: document.body
                      }).done(function(msg) {
                        console.log(msg);
                        if(msg.errors){
