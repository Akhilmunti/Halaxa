                                ...
                                <form action="" method="post" id="main">
                                    <div id="wizard" class="form_wizard wizard_horizontal">
                                        ...
                                        <?php 
                                            ...
                                            $locTitle = array();
                                            $locId = array();
                                            if(count($JobQualificationUG) > 0){
                                                $position = 0;
                                                foreach($JobQualificationUG as $ug){
                                                    $ugTitle[$position] = $ug->specialization." - ".$ug->qualification;
                                                    $ugId[$position] = $ug->specialization.",".$ug->qualification;
                                                    $position++;
                                                }
                                            }
                                            if(count($JobQualificationPG) > 0){
                                                $position = 0;
                                                foreach($JobQualificationPG as $pg){
                                                    $pgTitle[$position] = $pg->specialization." - ".$pg->qualification;
                                                    $pgId[$position] = $pg->specialization.",".$pg->qualification;
                                                    $position++;
                                                }
                                            }
                                            if(count($JobQualificationDOCTORATE) > 0){
                                                $position = 0;
                                                foreach($JobQualificationDOCTORATE as $doc){
                                                    $docTitle[$position] = $doc->specialization." - ".$doc->qualification;
                                                    $docId[$position] = $doc->specialization.",".$doc->qualification;
                                                    $position++;
                                                }
                                            }
                                            $ugTitle = implode("&$#", $ugTitle);
                                            $ugId = implode("|", $ugId);
                                            $pgTitle = implode("&$#", $pgTitle);
                                            $pgId = implode("|", $pgId);
                                            $docTitle = implode("&$#", $docTitle);
                                            $docId = implode("|", $docId);
                                            $locTitle = array();
                                            $locId = array();
                                            if(count($JobLocation) > 0){
                                                $position = 0;
                                                foreach($JobLocation as $loc){
                                                    $countryName= "";
                                                    $stateName= "";
                                                    foreach($countryname as $ctr){
                                                        if($ctr[0]->location_id == $loc->countryid){
                                                            $countryName = $ctr[0]->name;
                                                        }
                                                    }
                                                    foreach($statenames as $state){
                                                        if($state[0]->location_id == $loc->regionid){
                                                            $stateName = $state[0]->name;
                                                        }
                                                    }
                                                    $locTitle[$position] = $countryName." - ".$stateName." - ".$loc->city;
                                                    $locId[$position] = $loc->countryid.",".$loc->regionid.",".$loc->city;
                                                    $position++;
                                                }
                                            }
                                            $locTitle = implode("&$#", $locTitle);
                                            $locId = implode("|", $locId);
                                        ?>
                                        <hr class="hr-theme">
                                        <div class="p-5">
                                            ...
                                            if(count($Job) > 0){
                                                ...
                                                if($Jobsdata){
                                                    ...
                                                    $jobIndustry =  $Jobsdata->industry;
                                                    $jobFA =  $Jobsdata->functional_area;
                                                    $jobRole =  $Jobsdata->role;
                                                    $jobNO =  $Jobsdata->number_of_vacancies;
                                                    $jobET =  $Jobsdata->type;
                                                    $jobDesc =  $Jobsdata->description;
                                                    $jobRR =  $Jobsdata->keyskills;
                                                    
                                                    $currentPosition = $Jobsdata->positioncriteria;
                                                    $minYear = $Jobsdata->min_years;
                                                    $maxYear = $Jobsdata->max_years;
                                                    $minSalary = $Jobsdata->min_salary;
                                                    $maxSalary = $Jobsdata->max_salary;
                                                    $minAge = $Jobsdata->pref_min_age;
                                                    $maxAge = $Jobsdata->pref_max_age;
                                                    $minRelExp = $Jobsdata->rel_min_years;
                                                    $maxRelExp = $Jobsdata->rel_max_years;
                                                    $tenure = $Jobsdata->servicetenure;
                                                    
                                                    $videoURL = $Jobsdata->videourl;
                                                    $brief = $Jobsdata->brief;
                                                    $comments = $Jobsdata->comments;
                                                }else{
                                            ...
                                            <div id="step-2" style="min-height: 450px">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="hidden" value="<?php echo $jobId;?>" Name="JOBID" id="JOBID">
                                                        <input type="hidden" id="graduation_title_token" name="graduation_title_token" value="<?php echo $ugTitle;?>"/>
                                                        <input type="hidden" id="graduation_id_token" name="graduation_id_token" value="<?php echo $ugId;?>"/>
                                                        <input type="hidden" id="pg_title_token" name="pg_title_token" value="<?php echo $pgTitle;?>"/>
                                                        <input type="hidden" id="pg_id_token" name="pg_id_token" value="<?php echo $pgId;?>"/>
                                                        <input type="hidden" id="doctorate_title_token" name="doctorate_title_token" value="<?php echo $docTitle;?>"/>
                                                        <input type="hidden" id="doctorate_id_token" name="doctorate_id_token" value="<?php echo $docId;?>"/>
                                                        <input type="hidden"  class="form-control form-rounded" name="location_title_token" id="location_title_token" value="<?php echo $locTitle;?>">
                                                        <input type="hidden"  class="form-control form-rounded" name="location_id_token" id="location_id_token" value="<?php echo $locId;?>">
                                                        <select required="" class="form-control form-rounded" name="jobtitle" id="jobtitle">
                                                            ...
                                                            <?php foreach ($Jobs_seed_data_Functional_Area as $jobTitleHeading) { ?>
                                                                <?php for ($i = 0; $i < count($Jobs_RolesBy_Id[$jobTitleHeading->id]); $i++) { ?>
                                                                    <option value="<?php echo $Jobs_RolesBy_Id[$jobTitleHeading->id][$i]->value ?>" <?php if(trim($jobTitle) == trim($Jobs_RolesBy_Id[$jobTitleHeading->id][$i]->value)){ echo 'selected';}?>>
                                                                        <?php echo $Jobs_RolesBy_Id[$jobTitleHeading->id][$i]->value ?>
                                                                    </option>
                                                                <?php } ?>
                                                            <?php } ?>
                                                        </select>
                                                    ...
                                                    <div class="col-md-5">
                                                        <select required="" class="form-control form-rounded" name="industry" id="industry" onChange="removeerroeindustry()">
                                                            ...
                                                            <?php foreach ($Jobs_seed_data_Industry as $user7) { ?>
                                                                <option value="<?php echo $user7->id ?> -- <?php echo $user7->value ?>" <?php if(trim($jobIndustry) == trim($user7->id)){ echo " selected=''";}?>>
                                                    ...
                                                    <div class="col-md-5">
                                                        <select required="" class="form-control form-rounded" name="functionalarea" id="FunctionRole" onChange="FunctionalJobRole()" >
                                                            ...
                                                            <?php foreach ($Jobs_seed_data_Functional_Area as $user8) { ?>
                                                                <option value="<?php echo $user8->id ?> -- <?php echo $user8->value ?>" <?php if(trim($jobFA) == trim($user8->id)){ echo " selected=''";}?>>
                                                ...
                                                <div class="form-group row mt-4">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="number" class="form-control form-rounded" id="jobopning" name="jobopning" min="1" max="1000" onkeypress="return isOpningJob(event, this.id)" value="<?php echo $jobNO;?>"/>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                    <div class="col-md-10 offset-md-2 mt-3">
                                                        <span class="form-error-message text-danger text-danger" id="ItemRowError"></span>
                                                    ...
                                                    <div class="col-md-9 mt-2">
                                                        <div class="form-check form-check-inline">
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" class="custom-control-input" id="Employmenttype[1]" name="Employmenttype" value="1" <?php if($jobET == "1"){ echo "checked";}?>>
                                                                <label class="custom-control-label" for="Employmenttype[1]">Permanent</label>
                                                            </div>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" class="custom-control-input" id="Employmenttype[2]" name="Employmenttype" value="2" <?php if($jobET == "2"){ echo "checked";}?>>
                                                ...
                                                <div class="form-group row mt-4">
                                                    ...
                                                    <div class="col-md-9">
                                                        <textarea rows="5" type="number" class="form-control form-rounded-textarea" name="description" id="description" onChange="removeerroerd()"><?php echo $jobDesc;?></textarea>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                    <div class="col-md-10 offset-md-2 mt-3">
                                                        <span class="form-error-message text-danger text-danger" id="ItemRowError"></span>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <textarea rows="5" type="number" class="form-control form-rounded-textarea" name="requisites" id="requisites"><?php echo $jobRR;?></textarea>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                    <div class="col-md-10 offset-md-2 mt-3">
                                                        <span class="form-error-message text-danger text-danger" id="ItemRowError"></span>
                                            ...
                                            <div id="step-3">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-5">
                                                        ...
                                                        <div class="clearfix"></div>
                                                        <div id="UGStream">
                                                            <select id="program" required="" class="form-control form-rounded mt-3" id="UGStreams" name="UGStreams">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="clearfix"></div>
                                                    <div class="clearfix"></div>
                                                    <div id="divPostGraduation" class="col-md-9 offset-md-3 mt-3">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="clearfix"></div>
                                                    <div class="clearfix"></div>
                                                    <div id="divDoctorate" class="col-md-9 offset-md-3 mt-3">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-5">
                                                        <select required="" class="form-control form-rounded" name="currentposition" id="currentposition">
                                                            ...
                                                            <?php foreach ($Jobs_seed_data_Functional_Area as $jobTitleHeading) { ?>
                                                                <?php for ($i = 0; $i < count($Jobs_RolesBy_Id[$jobTitleHeading->id]); $i++) { ?>
                                                                    <option value="<?php echo $Jobs_RolesBy_Id[$jobTitleHeading->id][$i]->value ?>" <?php if(trim($currentPosition) == trim($Jobs_RolesBy_Id[$jobTitleHeading->id][$i]->value)){ echo 'selected=""'; }?>>
                                                                        <?php echo $Jobs_RolesBy_Id[$jobTitleHeading->id][$i]->value ?>
                                                                    </option>
                                                                <?php } ?>
                                                            <?php } ?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <input class="form-control form-rounded" type="number" name="servicetenure" id="servicetenure" value="<?php echo $tenure;?>"/>
                                                    </div>
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="row slider-labels">
                                                            <div class="col-6 col-xs-6">
                                                                <span class="text-left" id="exp_low"><?php echo $minYear;?></span>
                                                            </div>
                                                            <div class="col-6 col-xs-6 text-right">
                                                                <span class="text-right" id="exp_high"><?php echo $maxYear;?></span>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <input type="hidden" name="minexp" id="minexp" value="<?php echo $minYear;?>">
                                                                <input type="hidden" name="maxexp" id="maxexp" value="<?php echo $maxYear;?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <input type="hidden" value="<?php echo $minAge;?>" name="prefminage" id="prefminage">
                                                                <input type="hidden" value="<?php echo $maxAge;?>" name="prefmaxage" id="prefmaxage">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <input type="hidden" id="annualminpkg" name="annualminpkg" value="<?php echo $minSalary;?>">
                                                                <input type="hidden" id="annualmaxpkg" name="annualmaxpkg" value="<?php echo $maxSalary;?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-1">
                                            ...
                                            <div id="step-4" >
                                                ...
                                                <div class="form-group row mt-4">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input placeholder="Company Url" type="text" class="form-control form-rounded" id="CompanyVideoUrl" name="CompanyVideoUrl" value="<?php echo $videoURL;?>"/>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                    <div class="col-md-10 offset-md-2 mt-3">
                                                        <span class="form-error-message text-danger text-danger" id="ItemRowError"></span>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <textarea rows="5" placeholder="Company / Project Brief" type="text" class="form-control form-rounded-textarea" name="brief" id="brief">value="<?php echo $brief;?>"</textarea>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                    <div class="col-md-9 offset-md-3 mt-3">
                                                        <span class="form-error-message text-danger text-danger" id="ItemRowError"></span>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <textarea rows="5" placeholder="Comments" type="text" class="form-control form-rounded-textarea" name="comment" id="comment">value="<?php echo $comments;?>"</textarea>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                    <div class="col-md-9 offset-md-3 mt-3">
                                                        <span class="form-error-message text-danger text-danger" id="ItemRowError"></span>
                                            ...
                                            <div id="step-5">
                                                ...
                                                <h6 class="h-info"><b>Role Description</b></h6>
                                                <div id="pDescription">
                                                    <p class="p-info">
                                                        esolution he dissimilar precaution to e moments. Merit end sight front Manor equal it on again ye folly by match In so melancholy as an old get our.  
                                                        resolution he dissimilar precaution to e moments. Merit end sight front Manor equal it on again ye folly by match In so melancholy as an old get our. resolution he dissimilar precaution to e moments. Merit end sight front Manor equal it on again ye folly by match In so melancholy as an old get our. resolution he dissimilar precaution to e moments. Merit end sight front Manor equal it on again ye folly by match In so melancholy as an old get our. 
                                                    </p>
                                                </div>
                                                <h6 class="h-info"><b>Role Requisites</b></h6>
                                                <div id="pRequisites">
                                                    <p class="p-info">
                ...
                function init_SmartWizard() {
                    ...
                    function validateSteps(stepnumber) {
                        ...
                        if (stepnumber == 1) {
                            ...
                            $("#pNoOfOpenings").html('<p class="jobs-li-place text-justify p-info">' + jobopning + '</p>');
                            if (Employmenttype === 1) {
...
//                            var deliveryaddress = $('#deliveryaddress').val();
                ...
                noUiSlider.create(expSlider, {
                    start: [<?php echo $minYear;?>, <?php echo $maxYear;?>],
                    step: 1,
                    range: {
                        'min': [0],
                        'max': [55]
                ...
                noUiSlider.create(ageSlider, {
                    start: [<?php echo $minAge;?>, <?php echo $maxAge;?>],
                    step: 1,
                    range: {
                        'min': [0],
                        'max': [100]
                ...
                noUiSlider.create(annualPackageSlider, {
                    start: [<?php echo $minSalary;?>, <?php echo $maxSalary;?>],
                    step: 1,
                    range: {
                        'min': [50000],
                        'max': [100000]
        ...
        <script>
            ...
            function addGraduation() {
                ...
                var myLocations = $('#graduation_title_token').val() + "&$#" + ugCourseName + '-' + ugStreamName;
                $('#graduation_title_token').val(myLocations);

                var myLocationIds = $('#graduation_id_token').val() + "|" + ugCourseName + ',' + ugStreamName;
            ...
            function addPostGraduation() {
                ...
                var myLocations = $('#pg_title_token').val() + "&$#" + pgCourseName + '-' + pgStreamName;
                $('#pg_title_token').val(myLocations);

                var myLocationIds = $('#pg_id_token').val() + "|" + pgCourseName + ',' + pgStreamName;
            ...
            function displayPostGraduation() {
                ...
                for (var i = 0; i < allLocationSpan.length; i++) {
                    ...
                    if (!selected_title || 0 === selected_title.length) {
                        ...
                        btn.innerHTML += '<a href="#" class="badge-theme no-decoration" onClick ="postGraduationRemove(' + i + ')">' + selected_title + ' &nbsp;&nbsp;<i class="fa fa-times-circle-o"></i></a><input type ="hidden" name="pgcourseswithstreambuttonname"  id="pgcourseswithstreambuttonname" value="' + selected_title + '">';
                        btn.id += "pgSpan" + i;
            ...
            function addDoctorateInfo() {
                ...
                var pgStreamName = pgStream.value;
                //var pgStreamId = pgStream.options[pgStream.selectedIndex].innerHTML;
                var myLocations = $('#doctorate_title_token').val() + "&$#" + pgCourseName + '-' + pgStreamName;
                $('#doctorate_title_token').val(myLocations);

                var myLocationIds = $('#doctorate_id_token').val() + "|" + pgCourseName + ',' + pgStreamName;
            ...
            function displayDoctorateInfo() {
                ...
                for (var i = 0; i < allLocationSpan.length; i++) {
                    ...
                    if (!selected_title || 0 === selected_title.length) {
                        ...
                        btn.innerHTML += '<a href="#" class="badge-theme no-decoration" onClick ="doctorateInfoRemove(' + i + ')">' + selected_title + ' &nbsp;&nbsp;<i class="fa fa-times-circle-o"></i></a><input type ="hidden" name="doctoratecourseswithstreambuttonname"  id="doctoratecourseswithstreambuttonname" value="' + selected_title + '">';
                        btn.id += "docSpan" + i;
