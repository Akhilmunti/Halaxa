                            ...
                            <div class="save-job">
                              <div class="count">
                                <h2 class="job-title-name">
                                  <a href="<?php echo e(url('/employer/viewsavedjob/'.$campusdata->id.'')); ?>"><?php echo $campusdata->jobtitle?></a>
                                </h2>
                                <hr/>
                              </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-4">
                                  <a href="<?php echo e(url('/employer/editsavedcampusrecruitement/'.$campusdata->id.'')); ?>"><button type="button" class="btn btn-primary"> <i class="fa fa-edit"></i></button></a>                       
