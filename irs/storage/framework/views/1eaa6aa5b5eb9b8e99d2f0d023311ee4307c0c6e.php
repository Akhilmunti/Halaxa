              ...
              <div class="row">
                <div class="x_panel">
                  <div class="x_content">
                        ...
                        <div><?php if(isset($Deletejobresponse)) echo $Deletejobresponse; ?></div>
                        <div class="row">
                          <?php  if (count($savedjobsdata) > 0) { ?>
                          <?php  foreach ($savedjobsdata as $user6) { ?>
                          <div class="col-md-4  col-md-8 col-xs-12">
                            <div class="save-job">
                              <div class="count">
                                <h2 class="job-title-name">
                                     <a href="<?php echo e(url('/employer/viewsavedjob/'.$user6->id.'')); ?>" style="color: #4285f4;" target="_blank">
                                                                        <b>
                                                                            <?php echo $user6->jobtitle?>
                                                                        </b>
                                    </a>
                                </h2>
                                <hr/>
                              ...
                              <div class="save-job-details">
                                <div class="row">
                                  ...
                                  <div class="col-md-7">
                                    <h4 class="save-job-text"><?php echo $user6->company ?> </h4>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-md-5">
                                  ...
                                  <div class="col-md-7">
                                    <h4 class="save-job-text"><?php echo $user6->functional_area_value ?> </h4>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-md-5">
                                  ...
                                  <div class="col-md-7">
                                    <h4 class="save-job-text"> <?php echo $user6->job_role_value ?> </h4>
                                  </div>
                                </div>
                              </div>
                              <hr>
                              <div class="row"> 
                                <div class="col-md-12" >
                                    <h3 class="city-location address-bar"><b>Location</b><?php  foreach($locations[$user6->id] as $location)
                              ...
                              <div class="row">
                                <div class="col-md-4">
                                  <h4 style="city-location address-bar"><?php $createddate = explode(" ", $user6->created_at); echo $createddate = date('d M. Y', strtotime(date($createddate[0])));?>
                                  </h4>
                                </div>
                                <div class="col-md-4">
                                  <a href="<?php echo e(url('/employer/editsavedjobsposting/'.$user6->id.'')); ?>"><button type="button" class="btn btn-primary"> <i class="fa fa-edit"></i></button></a>                       
                                  <button type="button"  onClick="delete_jobs('<?php echo $user6->id ?>','<?php echo $user6->jobtitle ?>')" class="btn btn-danger" data-toggle="modal" data-target=".bs-example-modal-sm" ><i class="fa fa-trash-o"></i></button>
                                </div>
                                <div class="col-md-4">
                                    <section class="model-8 pull-right" style="margin-top:-10px;">
                                      <div class="checkbox">
                                        <input type="checkbox" <?php if($user6->Isfinished == '0'){ ?> disabled="disabled" <?php } else { ?> data-toggle="modal" data-target=".bs-active-modal-sm" onClick="postsavedjob('<?php echo $user6->id ?>','<?php echo $user6->jobtitle ?>')" <?php }  ?> />
                                          <label  style=""></label>
                                      </div>
                                    </section>
                                </div>
...
<form action="<?php echo url("/employer/searchsavedjobposting"); ?>" method="post" id="mins" enctype="multipart/form-data" >
