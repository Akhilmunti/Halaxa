    ...
    <div class="nav_menu">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" style="width: 100%;text-align: center">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">-->
                ...
                <li role="presentation"> <a href="<?php echo Config::get('constants.base.social_url'); ?>social/network" class="info-number" aria-expanded="false">My Network</a> </li>

                <li role="presentation"> <a href="<?php echo Config::get('constants.base.job_url'); ?>job_seeker" class="info-number" aria-expanded="false">Jobs </a> </li>
                    ...
                    <li role="presentation"> <a href="<?php echo Config::get('constants.base.job_url'); ?>employer/" class="info-number" aria-expanded="false">Recruit</a></li>

                    <li role="social-nav-active"> <a href="<?php echo Config::get('constants.base.social_url'); ?>buyer" class="info-number" aria-expanded="false">Buy </a></li>

                    <li class="presentation"> <a href="<?php echo Config::get('constants.base.social_url'); ?>vendor" class="info-number" aria-expanded="false">Sell </a></li>
