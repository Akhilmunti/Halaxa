                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane" id="about">
                                                ...
                                                <div class="form-group  col-md-12">
                                                    ...
                                                    <select name="job_type" id="job_type" class="form-control select2" style="width: 100%;" required="" onChange="removejob_type()" >
                                                        <option value="">Select Job Type</option>
                                                        <?php foreach ($job_type as $jobtype) { ?>
                                                            <option value="<?php echo $jobtype->value ?>"><?php echo $jobtype->value ?></option>
                                                        <?php } ?>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        <div class="form-group col-md-6" style="display:none;">
                                                            ...
                                                            <input type="text" class="form-control autocomplete" name="jobtitle" id="jobtitle" onkeypress="return checkQuote();"/>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-3" style="display:none;">
                                                            ...
                                                            <select name="minexp" id="minexp" class="form-control select2" style="width: 100%;" onChange="showmaxexprience()">
                                                        ...
                                                        <div class="form-group col-md-3" style="display:none;">
                                                            ...
                                                            <select class="form-control select2" name="maxexp" id="maxexp" style="width: 100%;" onChange="removeerroemaxexp()">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-3" style="display:none;">
                                                            ...
                                                            <input type="text" class="form-control autocomplete" onkeypress="return checkQuote();" name="currentposition" id="currentposition" />
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-4" style="display:none;">
                                                            ...
                                                            <div id="FunctionalRole" >
                                                                <select class="form-control select2" name="jobrole" id="jobrole" style="width: 100%;">
                                                                </select>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <select class="form-control select2" onChange="ShowUGStream()" id="UGCourses" >
                                                                ...
                                                                if($user3->value == 'BSc' || $user3->value == 'Bachelor' || $user3->value == 'Diploma'){
                                                                ?>
                                                    ...
                                                    <div class="col-sm-8 col-sm-offset-2">
                                                        <div class="row">
                                                            ...
                                                            foreach ($school_info as $school) {
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <label class="continr">
                                                                        <input type="checkbox" name="school_partners[]" id="school_partners<?php echo $i ?>"  value="<?php echo $school['S_Id'] ?>" class="myschools">
                                    ...
                                    if (condition == '1') {
                                        ...
                                        $.ajax({
                                            ...
                                            data: {
                                                ...
                                                EmailAddress: EmailAddress, PhoneNumber: PhoneNumber, obj, condition: condition, PAGENAME: PAGENAME, school_partner:school_partner, jobopning: jobopning, "_token": '<?php echo e(csrf_token()); ?>'}, context: document.body}).done(function (msg) {
                                            console.log(msg);
                                            //alert(msg);
                                            if (msg.errors) {
                                                console.log('errors');
                                        ...
                                        if (condition == '0') {
                                            ...
                                            $.ajax({
                                                ...
                                                data: {
                                                    //Jobtitle
                                                    //PAGENAME:PAGENAME,school_partner:school_partner
                                                    SOURCE: SOURCE, job_type: job_type, Jobtitle: Jobtitle, Ccmpanyname: Ccmpanyname, ug: ugarray, pg: pgarray,
                                                    doctorate: doctoratearray, country: countryarray, editor1: editor1,
                                                    editor2: editor2, editor3: editor3, editor4: editor4, minexp: minexp,
                                                    maxexp: maxexp, Employmenttype: Employmenttype, currency: currency,
                                                    ...
                                                    servicetenure: servicetenure, industry: industry,
                                                    FunctionRole: FunctionRole, jobrole: Jobrole, Name: Name,
                                                    EmailAddress: EmailAddress, PhoneNumber: PhoneNumber, obj, condition: condition, PAGENAME: PAGENAME, partner_id: school_partner, jobopning: jobopning, "_token": '<?php echo e(csrf_token()); ?>'}
                                                ,
