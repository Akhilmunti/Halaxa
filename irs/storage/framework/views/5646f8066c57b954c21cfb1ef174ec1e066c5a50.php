                                        ...
                                        <?php foreach ($savedjobsdata as $user6) { ?>
                                            <div class="col-md-4  col-md-8 col-xs-12">
                                                <div class="save-job">
                                                    <div class="count">
                                                        <h2 class="job-title-name">
                                                            <a href="<?php echo e(url('/employer/viewsavedjob/'.$user6->id.'')); ?>"><?php echo $user6->jobtitle ?></a>
                                                        </h2>
                                                        <hr/>
                                                    </div>
                                                ...
                                                ?>&nbsp&nbsp&nbsp-&nbsp&nbsp&nbsp
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <h4 style="city-location address-bar"><?php $createddate = explode(" ", $user6->created_at);
