    ...
    <body>
            ...
            <div class="wrapper">
                ...
                <div class="container mt-3" id="div_question_selector">
                    <div class="theme-card">
                        <div class="row">
                            <div class="col-md-12">
                                <h6 class="p-3"><b>Add Assessment Test</b></h6>
                                <hr class="hr-theme">
                            </div>
                        </div>
        ...
        <script>
            ...
            function proceedToNext(){
                ...
                if(noOfDays.length == 0 || noOfTests === "0 Tests" || timeToAnswer === "0 Minutes"){
...
//                });
                ...
                $('#questionstable').on('click', "[class*=td-link]", function () {
                    ...
                    if(totalRows == "3 Tests"){
                        alert("Max 3 Tests can be added!!");
                    }else{
                        ...
                        $("#no_of_tests").text(rowCount+" Tests");
