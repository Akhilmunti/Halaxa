                            ...
                            <div class="save-job">
                              <div class="count">
                                <h2 class="job-title-name">
                                     <a href="{{ url('/employer/viewsavedjob/'.$user6->id.'') }}" style="color: #4285f4;" target="_blank">
                                                                        <b>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-4">
                                  <a href="{{ url('/employer/editsavedjobsposting/'.$user6->id.'') }}"><button type="button" class="btn btn-primary"> <i class="fa fa-edit"></i></button></a>                       
