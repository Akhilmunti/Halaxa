                              ...
                              <div class="row">
                                <div class="col-sm-8 col-sm-offset-2">
                                  <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                      <label class="continr">
                                        <input type="checkbox" name="jobboards[]" id="jobboards<?php echo $i ?>"  value="<?php echo $jobboard->name?>" class="myjobboards">
                ...
                function saveAndPostCreatejob(condition) {
                  ...
                  if(condition=='1'){
                    $.ajax({
                      ...
                      EmailAddress:EmailAddress,PhoneNumber:PhoneNumber,obj,condition:condition,boards:boards,jobopning:jobopning,"_token":'{{csrf_token()}}'},context: document.body }).done(function(msg) {
                      console.log(msg);
                      if(msg.errors){
                        console.log('errors');
