                              ...
                              <i class="ti-user"></i>               
                                ...
                                <div class="tab-content">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                   ...
                                                   <input type="hidden" value="<?php echo $Jobsdata->id ?>" Name="JOBID" id="JOBID">
                                                    <input type="text" class="form-control" value="<?php echo $Jobsdata->jobtitle ?>" name="jobtitle" id="jobtitle" required=""/>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                   ...
                                                   <div id="column1" style="border: 1px solid; border-color:#d2d6de; min-height:120px;">
                                                      <div contenteditable="true" id="editor1"  class=".custom_scrollbar page"  style="padding: 0px 5px 0px 5px; min-height:120px;"><?php  echo $Jobsdata->description; ?>
                                                ...
                                                <div class="form-group col-md-6">
                                                   ...
                                                   <div id="column2" style="border: 1px solid; border-color:#d2d6de; min-height:120px;">
                                                      <div contenteditable="true" id="editor2"  class=".custom_scrollbar page" style="padding: 0px 5px 0px 5px; min-height:120px;"><?php   echo $Jobsdata->keyskills; ?>
                                              ...
                                              <input type="checkbox" class="flat" name="hidesalary" id="hidesalary" <?php if($Jobsdata->hidesalary == "1"){ ?> value= "1" checked <?php } else { ?>value = "0" <?php } ?>>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-4">
                                                       ...
                                                       <input type="url" name="companyvideourl" class="form-control" id="CompanyVideoUrl" placeholder="Company Url"  value="<?php echo $Jobsdata->videourl ?>">
                                                    </div>
                                    ...
                                    <?php foreach ($Jobs_seed_data_Current_Position as $user1) { ?>
                                      ...
                                      <option value="<?php echo $user1->id ?> -- <?php echo $user1->value ?>" name="<?php echo $user1->value ?>"<?php if($user1->id==$Jobsdata->positioncriteria) echo "Selected" ?>><?php echo $user1->value ?></option>
                                  <?php } ?>
                                              </select><label id="currentposition-error" class="error" for="currentposition"></label>
                                                    </div>
                                     ...
                                     <?php } ?>
                                           ...
                                           <div class="row">
                                            ...
                                            <div class="row"  id="pgblock" style="display:<?php if(count($JobQualificationPG)>0){ echo 'block'; } else{ echo 'none'; }  ?> ">
                                                ...
                                                <div class="form-group  col-md-1">
                                                    <button class="btn btn-success btn-sm streem" data-toggle="tooltip" title="Add PG!" id="Add_PG" onclick="addPG()" type="button"><i class="fa  fa-plus-circle"></i></button>
                                                </div>
                                                </div>
                                                <div class="col-md-12">
                                           ...
                                           <?php $PGdatacounter++; } ?>
                                            ...
                                            <div class="row" id="doctorateblock"  style="display:<?php if(count($JobQualificationPG)>0){ echo 'block'; } else{ echo 'none'; }  ?> " >
                                                ...
                                                <div class="form-group col-md-1">
                                                    <button class="btn btn-success btn-sm streem" data-toggle="tooltip" title="Add Doctorate!"  id="Add_Doctorate" onclick="addDoctorate()" type="button"><i class="fa  fa-plus-circle"></i></button>
                                                </div>
                                                </div>
                                                <div class="col-md-12">
                                     ...
                                     <?php } ?>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div id="column3" style="border: 1px solid; border-color:#d2d6de; min-height:120px;">
                                                      <div contenteditable="true" id="editor3"  class=".custom_scrollbar page" style="padding: 0px 5px 0px 5px; min-height:120px;"><?php echo $Jobsdata->brief; ?>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div id="column4"  style="border: 1px solid; border-color:#d2d6de; min-height:120px;">
                                                      <div contenteditable="true" id="editor4"  class=".custom_scrollbar page" style="padding: 0px 5px 0px 5px; min-height:120px;"><?php echo $Jobsdata->comments; ?>
...
<div class="row">
                              ...
                              <p>Select All</p>
                                                ...
                                                <label class="continr">
                                                <input type="checkbox" name="jobboards[]" id="jobboards<?php echo $i ?>"  value="<?php echo $jobboard->name?>" class="myjobboards" <?php if(array_search($jobboard->id,$insertedboardarray)!=""){echo "checked"; } ?>>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                        ...
                        <div class="col-md-12">
                        <h4><strong><i class="fa fa-book mr-1"></i>Basic Details</strong></h4>
  ...
  <div  id="a1"> <span class="close">&#215;</span>
