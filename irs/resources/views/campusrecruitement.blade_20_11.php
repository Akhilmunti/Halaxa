...
<html>
  ...
  <body class="nav-md"> 
        ...
        <div class="right_col" role="main" >
              ...
              <div class="form-group pull-right top_search">
                <div class="input-group">
                  <ol class="breadcrumb">
                    ...
                    <li class="active">Campus Recruitement 
                    </li>
                  </ol>
                </div>
              </div>
          ...
          <div class="row">
            <div class="panel panel-default ">
                  ...
                  <form action="" method="post" id="main"> 
                    ...
                    <div class="wizard-navigation">
                      ...
                      <ul>
                        ...
                        <li>
                          ...
                          <p style="margin-top: -20px;">ASSIGN SCHOOLS AND PARTNERS
                          </p>
                        </li>
                        <li>
                    ...
                    <div class="tab-content">
                      <div class="tab-pane" id="about">
                        ...
                        <label for="firstname">Job Type 
                                <span class="requerd">*
                                </span>
                              </label>
                          <select name="job_type" id="job_type" class="form-control select2" style="width: 100%;" required="">
                            <option value="">Select Job Type</option> 
                            <option value="Job">Job</option>
                            <option value="ODC">ODC</option>
                            <option value="Internship">Internship</option>
                          </select>
                          <label id="job_type-error" class="error" for="job_type"></label>
                          </div>
                        <div class="col-md-12">
                          <div class="row">
                            <div class="form-group col-md-6">
                              ...
                              <input type="hidden" value="CAMPUS" Name="PAGENAME" id="PAGENAME" readonly="">
                              <input type="hidden" value="2" Name="SOURCE" id="SOURCE" readonly="">
                          ...
                          <div class="row">
                            <div class="form-group col-md-6">
                              ...
                              <div id="column1" style="border: 1px solid; border-color:#d2d6de; min-height:120px;"> 
                                <div contenteditable="true" id="editor1"  class=".custom_scrollbar page" style="padding: 0px 5px 0px 5px;  min-height:120px;">
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <div id="column2" style="border: 1px solid; border-color:#d2d6de; min-height:120px;">
                                <div contenteditable="true" id="editor2"  class=".custom_scrollbar page" style="padding: 0px 5px 0px 5px;  min-height:120px;">
                                  <p class="form-control" id="editor2" name="editor2" required="">
                          ...
                          <div class="row">
                            <div class="form-group col-md-4">
                              ...
                              <input type="url" name="companyvideourl" class="form-control" id="CompanyVideoUrl" placeholder="Company Url" onChange="removeerrorCompanyVideoUrl()" >
                            </div>
                            <div class="form-group col-md-3">
                              ...
                              <select name="currentposition" id="currentposition" class="form-control select2" style="width: 100%;" onChange="removeerrorcurrentposition()" required="">
                                <option value="">Select Position
                                </option>          
                                <?php foreach ($Jobs_seed_data_Current_Position as $user1) { ?>
                                <option value="<?php echo $user1->id?> -- <?php echo $user1->value?>" name="<?php echo $user1->value?>">
                          ...
                          <div class="row" id="pgblock" style="display:none">
                            ...
                            <div class="form-group  col-md-1">
                              <button class="btn btn-success  btn-sm streem" data-toggle="tooltip" title="Add PG!" id="Add_PG" onclick="addPG()" type="button">
                                <i class="fa  fa-plus-circle">
                                </i>
                              </button>
                            </div>
                          ...
                          <div class="row" id="doctorateblock" style="display:none">
                            ...
                            <div class="form-group  col-md-1">
                              <button class="btn btn-success btn-sm streem" data-toggle="tooltip" title="Add Doctorate!"  id="Add_Doctorate" onclick="addDoctorate()" type="button">
                                <i class="fa  fa-plus-circle">
                                </i>
                              </button>
                            </div>
                          ...
                          <div class="row" id="divDoctorate"> 
                              ...
                              <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-4">
                                  ...
                                  <div class="form-group col-md-6">
                                    ...
                                    <div id="column4" style="border: 1px solid; border-color:#d2d6de; min-height:120px;">
                                      <div contenteditable="true" id="editor3"  class=".custom_scrollbar page" style="padding: 0px 5px 0px 5px;  min-height:120px;">
                                  ...
                                  <div class="form-group col-md-6">
                                    ...
                                    <div id="column4" style="border: 1px solid; border-color:#d2d6de; min-height:120px;">
                                      <div contenteditable="true" id="editor4"  class=".custom_scrollbar page" style="padding: 0px 5px 0px 5px;  min-height:120px;">
                            ...
                            <div class="tab-pane" id="account">
                              ...
                              <div class="row">
                                <div class="col-sm-8 col-sm-offset-2">
                                 ...
                                 <?php
                                    ...
                                    <div class="col-sm-4">
                                      <label class="continr">
                                        <input type="checkbox" name="school_partners[]" id="school_partners<?php echo $i ?>"  value="<?php echo $school->School_Name ?>" class="myschools">
                                        <div class="choice"  name="school_partners[]" id="school_partners<?php echo $i ?>"  value="<?php echo $school->School_Name ?>" class="myschools" data-toggle="wizard">
                                          <input type="checkbox" name="jobb" value="Develop" >
                                          <div class="card card-checkboxes card-hover-effect">
                              ...
                              <div class="col-md-12">
                                <div class="alert alert-info alert-dismissible">
                                  ...
                                  Jobs will be published on selected Partners within 24 hours.
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="wizard-footer">
                              <div class="pull-right">    
                                <input type='button' class='btn btn-reset btn-fill btn-default btn-wd' name='next' value='Reset' onclick="resetData()" />
              ...
              <div class="modal fade bs-example-modal-sm" id="postmodelincreatejob" tabindex="-1" role="dialog" aria-hidden="true">
   ...
   <script>
      ...
      $("input[class=myschools]").prop('checked', true);
                  }
                  else{
                    console.log('in check all else');
          $("input[class=myschools]").prop('checked', false);
                  }
                }
                                 );
              </script>
              <script>
                function addValidations(){
                  ...
                  var currentposition = crrentpstion.split(" -- ");
                  ...
                  document.getElementById("pcurrentposition").innerHTML = currentposition[1];
                  ...
                  for(var i=0; i<LocationOfWork.length; i++){
                    var PrefferedlocationButton = "<input type='button' data-toggle='tooltip'  style='margin-bottom:5px; margin-right:5px;'  class='btn btn-success btn-xs locationallfull' id='countrystatecity"+i+"' value='"+LocationOfWork[i]+"' >";
              ...
              <script>
                function saveAndPostCreatejob(condition) {
                  ...
                  if (condition=='1'){
                    var i=0;
                    $('.myschools:checked').each(function(){
                      var values = $(this).val();
                      school_partner[i] = values;
                      //console.log(boards[i]);
                      i++;
                    }
                                                  );
                    //console.log(i); 
                    console.log(school_partner);
                  }
                   if (condition=='0')
                  {
                    var jobTitle=document.getElementById('jobtitle').value;
                    var job_type=document.getElementById('job_type').value;
                    if(jobTitle.length==0 || job_type.length==0){
                      ...
                      if(job_type.length==0){
                        $("#myModal").remove();
                        document.getElementById('job_type-error').innerHTML = 'This field is required.';
                  ...
                  var currentposition = crrentpstion.split(" -- ",1);
                  ...
                  if(condition=='1'){
                    $.ajax({
                      ...
                      data:{
                      SOURCE:SOURCE,job_type:job_type,Jobtitle:Jobtitle,Ccmpanyname:Ccmpanyname,ug:ugarray,pg:pgarray,
                      ...
                      CompanyVideoUrl:CompanyVideoUrl,currentposition:currentposition,
                      servicetenure:servicetenure,industry:industry,
                      FunctionRole:FunctionRole,jobrole:Jobrole,Name:Name,
                      EmailAddress:EmailAddress,PhoneNumber:PhoneNumber,obj,condition:condition,PAGENAME:PAGENAME,school_partner:school_partner,jobopning:jobopning,"_token":'{{csrf_token()}}'},context: document.body }).done(function(msg) {
                      console.log(msg);
                      if(msg.errors){
                        console.log('errors');
                    ...
                    if(condition=='0'){
                      ...
                      $.ajax({
                        ...
                        servicetenure:servicetenure,industry:industry,
                        FunctionRole:FunctionRole,jobrole:Jobrole,Name:Name,
                        EmailAddress:EmailAddress,PhoneNumber:PhoneNumber,obj,condition:condition,PAGENAME:PAGENAME,school_partner:school_partner,jobopning:jobopning,"_token":'{{csrf_token()}}'}
                             ,
...
<?php 
$job_titles = array();
foreach ($Jobs_seed_data_Functional_Area as $job) { 
