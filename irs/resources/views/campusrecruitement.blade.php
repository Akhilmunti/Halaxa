                                        ...
                                        if (condition == '0') {
                                            ...
                                            $.ajax({
                                                ...
                                                data: {
                                                    ...
                                                    servicetenure: servicetenure, industry: industry,
                                                    FunctionRole: FunctionRole, jobrole: Jobrole, Name: Name,
                                                    EmailAddress: EmailAddress, PhoneNumber: PhoneNumber, obj, condition: condition, PAGENAME: PAGENAME, partner_id: school_partner, jobopning: jobopning, "_token": '{{csrf_token()}}'}
                                                ,
