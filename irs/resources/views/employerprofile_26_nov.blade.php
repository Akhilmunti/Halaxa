...
<head>
    ...
    <title>IRS | Employer Profile</title>
...
<div class="right_col" role="main" >
                  ...
                  <div class="col-md-3">
                      ...
                      <div class="profile_img">
                        ...
                        <div id="crop-avatar">
                          ...
                          <img class="img-responsive avatar-view" src="<?php echo url('/'); ?>/public/images/employer/<?php if(strlen($profile->path) > 0){echo $profile->path; } else { echo 'default.jpg'; }  ?>" alt="Avatar" title="Change the avatar">
                        ...
                        <div class="profile_title">
                            ...
                            <div class="col-md-6">
                               ...
                               <div class="col-md-6">
                                ...
                                <button class="btn btn-success btn-sm pull-right"  data-toggle="modal" data-target=".bs-example-modal-lg" type="button"  title="Add Education"><i class="glyphicon glyphicon-edit"></i></button>
 ...
 <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <h4><?php if ($profile->company_type == 1){ echo 'Company Recruter';} else{ echo 'Recuritment Agency'; } ?></h4>  
 ...
 <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <h4><?php echo $profile->website ?></h4>  
 ...
 <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <h4><?php echo trim($profile->addline1); ?></h4>  
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <h4><?php echo trim($profile->about); ?></h4>  
      ...
      <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
          ...
          <div class="modal-header">
            ...
            <h4 class="modal-title" id=""><center><h3> COMPANY DETAILS</h3>  </center></h4>
          ...
          <form action="editemployerprofile" method="post" id="mains" enctype="multipart/form-data">
              ...
              <div class="row">
                    ...
                    <div class="col-sm-5  col-sm-offset-1 ">                       
                        ...
                        <input name="companyname" id="companyname" type="text" value="<?php echo $profile->company ?>" class="form-control" placeholder="Enter Company..." >
                        ...
                        <div class="form-group">
                            ...
                            <input type="radio" class="flat" name="companytype"  value="1" <?php if($profile->company_type==1) echo "checked"; ?> style="position: absolute; opacity: 0; top: 0%; left: 0%;  margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px;" required />Company

                            <input type="radio" class="flat" name="companytype"  value="2" <?php if($profile->company_type==2) echo "checked"; ?> style="position: absolute; opacity: 0; top: 0%; left: 0%;  margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; " /> 
...
<div class="panel-body" align="center">
                    ...
                    <img src="<?php echo url('/'); ?>/public/images/employer/<?php if(strlen($profile->path) > 0){echo $profile->path; } else {  }  ?>" style="" class="picture-src" id="wizardPicturePreview" title=""/>
            ...
            <div class="row">
                  ...
                  <div class="col-sm-5 col-sm-offset-1">
                    <div class="form-group">
                        ...
                        <label>Pincode <span class="requerd">*</span></label>
                  ...
                  <div class="col-sm-5">
                    <div class="form-group">
                        ...
                        <input name="website" id="website" type="url" value="<?php echo $profile->website ?>" class="form-control" placeholder="Enter Website...">

    

                    </div><div id="website-error"></div>
          ...
          <div class="row">
                 ...
                 <div class="form-group col-sm-5 col-sm-offset-1">
                        ...
                        <label>Address <span class="requerd">*</span></label>
                          ...
                          <div id="column1" class=".custom_scrollbar page" style="border: 1px solid; border-color:#d2d6de; min-height:120px;">

                          <div contenteditable="true" id="editor1" style="padding: 0px 5px 0px 5px; min-height:120px;">
                ...
                <div class="col-sm-5">
                        ...
                        <div id="column2" class=".custom_scrollbar page" style="border: 1px solid; border-color:#d2d6de; min-height:120px;">

                        <div contenteditable="true" id="editor2" style="padding: 0px 5px 0px 5px; min-height:120px;">
...
*/
     ...
     if(pincode.trim().length==0){
        ...
        pincodeerror= "<div style='color:#EB5E28; font-size: 0.8em;' data-toggle='tooltip'><b>This field is required.</b> </div>";

     document.getElementById("pincode-error").innerHTML = pincodeerror;
