                            ...
                            <div class="form-group pull-right top_search">
                                <div class="input-group">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="active">Re-Create Job Posting 
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                            ...
                                            <div class="tab-pane" id="about">
                                                ...
                                                <?php foreach ($Job as $Jobsdata) { ?>
                                                    ...
                                                    <div class="col-md-12">
                                                            ...
                                                            <div class="form-group col-md-3">
                                                                ...
                                                                <select name="annualminpkg" class="form-control select2" id="annualminpkg"  style="width: 100%;" onChange="ShowMaxAnnualIncome()"  required="">
                                                                    ...
                                                                    <?php if ($Jobsdata->currency_type == 'INR') { ?>
                                                                        ...
                                                                        <option class='minannualincome' value='12477' <?php
                                                                        if (strlen($Jobsdata->min_salary) > 0) {
                                                                            if ($Jobsdata->min_salary == 12477) {
                                                                                echo "Selected";
                                                                            }
                                                                        }
                                                                        ?> >Less than 50000</option>
                                                                                <?php for ($x = 50000; $x <= 100000; $x = $x + 10000) { ?>
                                                                            <option class='minannualincome' value='<?php echo $x ?>'<?php
                                                                            if (strlen($Jobsdata->min_salary) > 0) {
                                                                                if ($Jobsdata->min_salary == $x) {
                                                                                    echo "Selected";
                                                                                }
                                                                            }
                                                                            ?> > <?php echo number_format($x) ?> </option>
                                                                                    <?php
                                                                                }
                                                                                for ($y = 125000; $y <= 500000; $y = $y + 25000) {
                                                                                    ?>
                                                                            <option class='minannualincome' value='<?php echo $y ?>' <?php
                                                                            if (strlen($Jobsdata->min_salary) > 0) {
                                                                                if ($Jobsdata->min_salary == $y) {
                                                                                    echo "Selected";
                                                                                }
                                                                            }
                                                                            ?> > <?php echo number_format($y) ?></option>
                                                                                    <?php
                                                                                }
                                                                            ...
                                                                            <?php
                                                                            if (strlen($Jobsdata->min_salary) > 0) {
                                                                                if ($Jobsdata->min_salary == $z) {
                                                                                    echo "Selected";
                                                                                }
                                                                            }
                                                                            ?> ><?php echo number_format($z) ?> </option>
                                                                                    <?php
                                                                                }
                                                                            ...
                                                                            <?php
                                                                            if (strlen($Jobsdata->min_salary) > 0) {
                                                                                if ($Jobsdata->min_salary == $p) {
                                                                                    echo "Selected";
                                                                                }
                                                                            }
                                                                            ?> > <?php echo number_format($p) ?></option>
                                                                                    <?php
                                                                                }
                                                                            ...
                                                                            <?php
                                                                            if (strlen($Jobsdata->min_salary) > 0) {
                                                                                if ($Jobsdata->min_salary == $q) {
                                                                                    echo "Selected";
                                                                                }
                                                                            }
                                                                            ?> > <?php echo number_format($q) ?></option>
                                                                                    <?php
                                                                                }
                                                                            ...
                                                                            <?php
                                                                            if (strlen($Jobsdata->min_salary) > 0) {
                                                                                if ($Jobsdata->min_salary == $r) {
                                                                                    echo "Selected";
                                                                                }
                                                                            }
                                                                            ?> > <?php echo number_format($r) ?></option>
                                                                                <?php } ?>
                                                                        <option class='minannualincome' value='10000000' <?php
                                                                        if (strlen($Jobsdata->min_salary) > 0) {
                                                                            if ($Jobsdata->min_salary == 10000000) {
                                                                                echo "Selected";
                                                                            }
                                                                        }
                                                                        ?> >  100,00,000 & above </option>
                                                                            <?php } else if ($Jobsdata->currency_type == 'USD') {
                                                                                ?>
                                                                        <option class='minannualincome' value='786'<?php
                                                                        if (strlen($Jobsdata->min_salary) > 0) {
                                                                            if ($Jobsdata->min_salary == 786) {
                                                                                echo "Selected";
                                                                            }
                                                                        }
                                                                        ?> > Less than 5,000 </option>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <input class="flat" name='checkPG' type="checkbox" id="chkPG" <?php
                                                        ...
                                                        <div class="row"  id="pgblock" style="display:<?php
                                                        if (count($JobQualificationPG) > 0) {
                                                            echo 'block';
                                                        } else {
                                                            echo 'none';
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <input class="flat" name='checkDoctorate' type="checkbox" id="chkPG" <?php
                                                        ...
                                                        <div class="row" id="doctorateblock"  style="display:<?php
                                                        if (count($JobQualificationPG) > 0) {
                                                            echo 'block';
                                                        } else {
                                                            echo 'none';
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-8 col-sm-offset-2">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <?php
                                                            foreach ($job_boards_data as $jobboard) {
                                                                $i == 0;
                                                                ?>
                                                                ...
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <label class="continr">
                                                                        <input type="checkbox" name="jobboards[]" id="jobboards<?php echo $i ?>"  value="<?php echo $jobboard->name ?>" class="myjobboards" <?php
                                                                        if ($jobboard->name == "FoodLinked india") {
                                                                            echo "checked";
                                                                            echo " readonly";
                                                                        }
                                                                        ?> <?php
                                                                        if (in_array($jobboard->id, $insertedboardarray, TRUE)) {
                                                                            echo "checked";
                                                                        }
                                                                        ?>>
