...
class Home extends CI_Controller {
    ...
    public function index() {
        ...
        $data['rfqsCount'] = count($this->rfq_model->getAllRFQsByfavs($mUserId, "0"));
        $data['quotedCount'] = count($this->vendor_model->getAllQuotedRFQs($mUserId));
        $data['poissuedCount'] = count($this->vendor_model->getAllPOIssuedRFQs("1", $mUserId));
