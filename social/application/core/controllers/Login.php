        ...
        if ($this->input->post()) {
            ...
            if ($this->form_validation->run()) {
                ...
                if ($checkEmailExist) {
                    ...
                    if ($pic_err_flag == 0) {
                        $this->session->set_flashdata('Sucess', 'Registrations are temporarily stopped, Please contact Foodlinked admin for further details.');
                    ...
                    $this->load->view('social/login_new', $pic_err);
                }
            } else {
                $data['left_content'] = "network";
                $this->load->view('social/login_new', $data);
            }
        } else {
            $data['left_content'] = "network";
            $this->load->view('social/login_new', $data);
    ...
    public function sendPassword() {
        ...
        if ($check) {
            ...
            if ($checkEmailExist) {
                ...
                $messageLink = "https://foodlinked.co.in/social/login/newPassword/" . $checkEmailExist->User_Id;
                $message = "
<html>
<head>
</head>
