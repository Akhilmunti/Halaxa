        ...
        <div id="main">
            <div id="envelope">
                <?php if (isset($userData['authURL'])) { ?>
                    ...
                    <hr>
                    <div id="content">
                        <center><a href="<?php echo $userData['authURL']; ?>"><img id="google_signin" src="<?php echo base_url(); ?>images/fb_login.png" width="100%" ></a></center>
                    </div>
                <?php } else { 
                    if($userData){
                    ...
                    <header id="info">
                        ...
                        <?php echo '<p class="welcome"><i>Welcome ! </i>' . $fName. "</p>"; ?></a><a class='logout' href='<?php echo $logout;?>'>Logout</a>
                    </header>
                    <?php
                    if ($userData) {
                        //print_r($userData);
