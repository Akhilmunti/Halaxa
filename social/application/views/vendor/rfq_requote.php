                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="theme-card p-3">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h4 class="theme-header-text">Under Negotiation RFQs</h4>
                                        </div>
                                        <div class="col-md-12">
                                            <form method="POST" action="<?php echo base_url('vendor/requote_rfq'); ?>">
                                            ...
                                            foreach ($itemdata as $key => $itemrow) {
                                                ...
                                                <tr>
                                                    <td style="width: 120px">
                                                        ...
                                                        <input hidden="" value="<?php echo $value; ?>" readonly="" type="text" name="quotedItems[<?php echo $itemiter; ?>][]" class="form-control"/>
                                                    </td>
                                                    <td>
                                                        <input type="hidden" value="<?php echo $itemrow[1]; ?>" />
                                                        <input value="<?php echo $itemrow[1] ?>" required="" type="text" name="quotedItems[<?php echo $itemiter; ?>][]" class="form-control form-control-table"/>
                                                        <span class="text-theme font-sm">
                                                            <b><?php echo $itemrow[1]; ?></b>
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <input max="<?php echo $mKeyData; ?>" value="<?php echo $itemrow[2] ?>" onchange="calculateQuantityTotal(<?php echo $unique; ?>)" required="" id="quantity<?php echo $unique; ?>" type="number" name="quotedItems[<?php echo $itemiter; ?>][]" class="form-control form-control-table"/>
                                                        <span class="text-theme font-sm">
                                                            <b><?php echo $itemrow[2]; ?> Requested</b>
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <p class="table-p text-black">
                                                            ...
                                                            if (is_numeric($itemrow[3])) {
                                                                foreach ($uoms as $key => $uom) {
                                                                    if ($itemrow[3] == $uom['U_Id']) {
                                                                        echo $uom['Uom'];
                                                                    }
                                                                }
                                                            } else {
                                                                $uom = preg_replace('/[0-9]+/', '', $itemrow[3]);
                                                                echo $uom;
                                                            }
                                                            ?>
                                                        </p>
                                                        ...
                                                        ?>" readonly="readonly" type="text" name="quotedItems[<?php echo $itemiter; ?>][]"  class="form-control form-control-table"/>
                                                        <span class="form-error-message text-danger"></span>
                                                    </td>
                                                    <td>
                                                        <input required="" value="<?php echo $itemrow[4] ?>" id="price<?php echo $unique; ?>" onchange="calculateTotal(<?php echo $unique; ?>)" type="number" name="quotedItems[<?php echo $itemiter; ?>][]" class="form-control form-control-table"/>
                                                        <span class="text-theme font-sm">
                                                            <b>&nbsp;</b>
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <input value="<?php echo $itemrow[5] ?>" readonly="" required="" id="amount<?php echo $unique; ?>" type="number" name="quotedItems[<?php echo $itemiter; ?>][]" class="form-control form-control-table"/>
                                                        <span class="text-theme font-sm">
                                                            <b>&nbsp;</b>
                                                        </span>
                                                    </td>
