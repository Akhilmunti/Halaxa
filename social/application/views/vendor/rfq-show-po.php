                                        ...
                                        <div class="x_content">
                                            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                                <ul id="myTab1" class="nav nav-tabs bar_tabs left" role="tablist">
                                                    ...
                                                    <li role="presentation" class=""><a href="#tab_content33" role="tab" id="profile-tabb" data-toggle="tab" aria-controls="Preview" aria-expanded="false">Preview</a>
                                                    </li>
                                                </ul>
                                                <div id="myTabContent2" class="tab-content">
                                                    ...
                                                    <div role="tabpanel" class="tab-pane fade" id="tab_content22" aria-labelledby="profile-tab">
                                                        ...
                                                        <table id="RfqInfoTable" class="table order-list table-striped" style="overflow-x: scroll">
                                                            <thead>
                                                                <tr>
                                                                    <td>Sl No</td>
                                                                    <td>Item Service</td>
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                $itemdata = json_decode($qouted['quotedItems']);
                                                                $iter = 0;
                                                                foreach ($itemdata as $key => $itemrow) {
                                                                    ...
                                                                    <tr>
                                                                        <td class="col-sm-1">
                                                                            <input type="text" value="<?= $iter; ?>" name="iteminfo[1][]" value="1" readonly class="form-control" />
                                                                        </td>
                                                                        <td class="col-sm-3"><input disabled="" value="<?= $itemrow[0]; ?>" type="text" name="iteminfo[1][]"  class="form-control"/></td>
                                                                        <td class="col-sm-3"><input disabled="" value="<?= $itemrow[1]; ?> <?= $itemrow[2]; ?>" type="text" name="iteminfo[1][]"  class="form-control"/></td>
                                                                        <td class="col-sm-2"><input disabled="" value="<?= $itemrow[4]; ?>" type="text" name="iteminfo[1][]"  class="form-control"/></td>
                                                                        <td class="col-sm-2"><input disabled="" value="<?= $itemrow[5]; ?> <?= $itemrow[3]; ?>" type="text" name="iteminfo[1][]"  class="form-control"/></td>
                                                                    </tr>
                                                                    <?php
                                                                }
                                                                ?>
                                                    ...
                                                    <div role="tabpanel" class="tab-pane fade" id="tab_content33" aria-labelledby="profile-tab">
                                                        <div class="x_title">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <a href="#" id="cmd" class="btn btn-dark" style="float: right">Download As PDF</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="content_pdf">
                                                            <div  style="background-color: #ffffff; padding: 10px">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <h4>RFQ ID : <?php echo $rfqdata['RFQ_Id'] ?></h4>
                                                                        <hr>
                                                                    </div>
                                                                    <div class="col-md-4 col-sm-6">
                                                                        <label class="control-label">Group</label>
...
?>
        ...
        <script>
            ...
            $('#cmd').click(function () {
                ...
                pdf.addHTML($('.content_pdf')[0], function () {
                    pdf.save('Test.pdf');
                });
            });
        </script>
