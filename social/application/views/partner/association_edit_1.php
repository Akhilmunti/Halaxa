            ...
            <div class="right_col" role="main">
                <div class="page-title">
                    <div class="title_left">
                        <h3>Association Partner Application</h3>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_content">
                                <div class="row">
                                    <form id="Form" method="POST" action="<?php echo base_url() . "partner/association/actionEdit/" . $mId; ?>" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-4 partners-form">
                                            ...
                                            <input type="file"  class="form-control form-rounded-partner" accept=".png, .jpg, .jpeg" id="school_profile" name="school_profile"  />
