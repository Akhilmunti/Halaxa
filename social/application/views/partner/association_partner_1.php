                                ...
                                <div class="row">
                                    <div class="col-md-9 col-xs-12">
                                        ...
                                        <div class="border-dark" role="tabpanel" data-example-id="togglable-tabs">
                                            <ul id="myTab" class="nav nav-pills nav-stacked hidden-lg hidden-md hidden-sm">
                                            ...
                                            <div id="myTabContent" class="tab-content">
                                                <div role="tabpanel" class="tab-pane fade <?php echo $activemain; ?> in" id="tab_content1" aria-labelledby="home-tab"> 
                                                    <div class="light-back">
                                                        <form id="Form" method="POST" action="<?php echo base_url() . "partner/association/add_post"; ?>" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                                    ...
                                                    <ul class="messages post-card">
                                                        ...
                                                        if (!empty($conversations)) {
                                                            foreach ($conversations as $key => $conversation) {
                                                                ...
                                                                <li> 
                                                                    <?php
                                                                    $file = base_url('uploads/') . $conversation['Logo'];
                                                                    if (@getimagesize($file)) {
                                                                        $file = $file;
                                                                    } else {
                                                                        $file = base_url('assets/images/favi.png');
                                                                    ...
                                                                    <div class="message_date">
                                                                        ...
                                                                        <?php if ($conversation['posted_id'] == $this->session->userdata('login_id')) { ?>
                                                                            <a href="<?php echo base_url("partner/association/delete_post/"); ?><?php echo $conversation['id']; ?>" class="date"><i class="fa fa-trash"></i></a>                                                                            
                                                                        <?php } ?>
                                                                    </div>
                                                                    <div class="message_wrapper">
                                                                        ...
                                                                        <?php } else { ?>
                                                                            <p class="url"> <span class="fs1 text-info" aria-hidden="true" data-icon=""></span> <a href="https://foodlinked.com/social/uploads/<?php echo $conversation['attachment']; ?>" download><i class="fa fa-paperclip"></i> <?php echo $conversation['attachment']; ?> </a> </p>
                                                                        <?php } ?>
                                                                    </div>
                                                                </li>
        ...
        <!--                                                                            <td><?php echo $rating['Name']; ?></td>-->
                                                                            ...
                                                                            <td>
                                                                                <?php if ($rating['status'] == 0) { ?>
                                                                                    <a href="<?php echo base_url('partner/association/publishRating/') . $rating['id']; ?>" class="btn btn-xs btn-dark">Publish</a>
                                                                                <?php } else { ?>
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="tab_content9" aria-labelledby="profile-tab">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-9">
                                                            <div class="light-back">
                                                                <form id="formThree" enctype="multipart/form-data" class="form-horizontal form-label-left" action="<?php echo base_url('partner/association/sendRatings'); ?>" method="post">
                                                                    <div class="row">
                                                                        <div class="col-md-12 col-xs-12">
                                                                            <div class="form-group">
