                        ...
                        <div class="container">
                            ...
                            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                                <ul class="navbar-nav ml-auto mt-2 mt-lg-0 nav-theme-li">
                                    <li class="nav-item">
                                        <a href="<?= base_url("partner/apply"); ?>" class="no-decoration btn btn-white font-bold my-2 my-sm-0 mr-3" type="submit">Apply</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-6 mx-auto text-center">
                                        ...
                                        <form id="Form" method="POST" action="<?php echo base_url() . "partner/home/signIn"; ?>" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <select name="log_type" id="log_type" accesskey="target" class="form-control form-control-sm" required>
                                                    <option value="" <?php
                                                    if (set_value('log_type') == '') {
                                                        echo 'selected';
                                                    }
                                            ...
                                            <div class="form-group">
                                                <input required="" type="email" class="form-control form-control-sm" name="username" placeholder="Email" value="<?php echo set_value('username'); ?>">
                                            </div>
                                            <div class="form-group">
...
<!--                                            <a class="text-muted mt-2 font-13" href="#"><span class="anchor-color">Forgot the password?</span> Click here</a>-->
                                            <br><br>
                                            <a class="text-muted font-13" href="<?= base_url("partner/apply"); ?>"><span class="anchor-color">Don't you have an partner account?</span> Apply</a>
                                        </form>
                                    </div>
                                </div>
                            </div>
