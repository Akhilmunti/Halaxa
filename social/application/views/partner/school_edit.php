                                            ...
                                            <div class="col-md-12 p-5">
                                                <div class="post-card pl-5 pr-5 pt-3 pb-3">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="text" id="school_name" class="form-control form-rounded-partner" name="school_name" required value="<?php echo $mSchoolName; ?>"/>
                                                    ...
                                                    <div class="inner-footer">
                                                        <input hidden="" value="Update" class="btn btn-sm btn-dark" id="edit_school" name="edit_school">
