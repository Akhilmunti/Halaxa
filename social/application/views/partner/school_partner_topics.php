                                            ...
                                            foreach ($topics as $key => $topic) {
                                                ...
                                                <li>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-11">
                                                            <a class="topic-name" href="<?php echo base_url('partner/school/actionCommunityPost/' . $topic['ct_key']); ?>"><?php echo $topic['ct_topic']; ?></a> <span class="topic-last-light ml-2">(<?php echo $posts; ?> Posts)</span>
