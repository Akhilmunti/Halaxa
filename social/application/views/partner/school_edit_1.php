                                ...
                                <div class="row">
                                    <form id="Form" method="POST" action="<?php echo base_url() . "partner/school/edit/" . $mId; ?>" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                        <div class="col-md-4 partners-form">
                                            ...
                                            <input type="text" id="school_name" class="form-control" name="school_name" required 
                                            ...
                                            <input type="text" id="school_address" class="form-control" placeholder="Address" name="school_address" required value="<?php echo $mAddress; ?>"/>
                                            <?php if (form_error('school_address')) { ?><span style="color: #E68F8F;"><?php echo form_error('school_address'); ?></span> <?php } ?>
                                            <input type="text" id="school_location" placeholder="Location" class="form-control" name="school_location" required value="<?php echo $mLocation; ?>"/>
                                            <?php if (form_error('school_location')) { ?><span style="color: #E68F8F;"><?php echo form_error('school_location'); ?></span> <?php } ?>

                                            <label for="fullname">Country *:</label>
                                            <input value="<?php echo $mCountry; ?>" class="form-control" name="country" id="loc-automplete" list="country">
                                            <datalist id="country">
                                            ...
                                            <select name="state" id="state-automplete" class="form-control" required>
                                                <?php
                                            ...
                                            <select name="city" id="city-automplete" class="form-control" required="">
                                                <?php
                                                foreach ($city as $ci) {
                                                    if ($mCity == $ci['name']) {
                                            ...
                                            <input value="<?php echo $mZipCode ?>" type="number" id="pincode" class="form-control" name="pincode" required value="<?php echo set_value('pincode'); ?>"/>
                                        ...
                                        <div class="col-md-4 partners-form">
                                            ...
                                            <input type="text" id="website" class="form-control" name="website" value="<?php echo $mWebsite; ?>"/>
                                            ...
                                            <input required type="text" id="hyperlink" class="form-control" name="hyperlink" required value="<?php echo $mVideoUrl; ?>"/>
                                            ...
                                            <input type="text" id="overview" class="form-control" name="overview" required value="<?php echo $mOverview; ?>"/>
                                            ...
                                            <input required type="text" id="no_of_students" class="form-control" name="no_of_students" required value="<?php echo $mNoOfStudents; ?>"/>
                                            ...
                                            <input type="file"  class="form-control" accept=".png, .jpg, .jpeg" id="school_logo" name="school_logo"   />
                                            ...
                                            <input type="file"  class="form-control" accept=".png, .jpg, .jpeg" id="school_profile" name="school_profile"   />
                                            ...
                                            <textarea required class="form-control" id="group_description" name="group_description" rows="3" required><?php echo $mGD ?></textarea>
                                        ...
                                        <div class="col-md-4 partners-form">
                                            ...
                                            <input type="text" id="salutation" class="form-control" name="salutation" required value="<?php echo $mSalutation; ?>"/>
                                            <?php if (form_error('salutation')) { ?><span style="color: #E68F8F;"><?php echo form_error('salutation'); ?></span> <?php } ?>
                                            <label for="fullname">First Name * :</label>
                                            <input type="text" id="first_name" class="form-control" name="first_name" required value="<?php echo $mFirstName; ?>"/>
                                            <?php if (form_error('first_name')) { ?><span style="color: #E68F8F;"><?php echo form_error('first_name'); ?></span> <?php } ?>
                                            <label for="fullname">Last Name * :</label>
                                            <input type="text" id="last_name" class="form-control" name="last_name" required value="<?php echo $mLastName; ?>"/>
                                            ...
                                            <input type="email" id="email_id" class="form-control" name="email_id" required value="<?php echo $mEmail; ?>" readonly/>
                                            ...
                                            <div class="col-md-4">
                                                <input type="number" placeholder="Area code" id="area_code" class="form-control" name="area_code" required value="<?php echo $mPACode; ?>"/>
                                                <?php if (form_error('area_code')) { ?><span style="color: #E68F8F;"><?php echo form_error('area_code'); ?></span> <?php } ?>
                                            </div>
                                            <div class="col-md-4 no-padding">
                                                <input type="number" placeholder="Number" id="contact" class="form-control" name="contact" required value="<?php echo $mPhoneNo; ?>"/>
                                                <?php if (form_error('contact')) { ?><span style="color: #E68F8F;"><?php echo form_error('contact'); ?></span> <?php } ?>
                                            </div>
                                            <label for="fullname">Fax :</label>
                                            <div class="clearfix"></div>
                                            <div class="col-md-4 no-padding">
                                                <select id="fax_type" name="fax_type" class="form-control">
                                                    <option value="">Choose..</option>
                                            ...
                                            <div class="col-md-4">
                                                <input type="number" placeholder="Area code" id="fax_area_code" class="form-control" name="fax_area_code" value="<?php echo $mFACode; ?>"/>
                                                <?php if (form_error('fax_area_code')) { ?><span style="color: #E68F8F;"><?php echo form_error('fax_area_code'); ?></span> <?php } ?>
                                            </div>
                                            <div class="col-md-4 no-padding">
                                                <input type="number" placeholder="Number" id="fax_contact" class="form-control" name="fax_contact" value="<?php echo $mFaxNo; ?>"/>
                                        ...
                                        <div class="text-center">
                                            <input type="submit" value="Update" class="btn btn-sm btn-dark" id="edit_school" name="edit_school">
                                        </div>
                                    </form>
                                </div>
                            </div>
