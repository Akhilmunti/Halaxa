                                                        ...
                                                        <div id="myTabContent" class="tab-content">
                                                            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab"> 
                                                                ...
                                                                <div class='share-rectangle'> 
                                                                    ...
                                                                    <a target="_blank" href="http://www.facebook.com/sharer.php?u=http://staging.foodlinked.co.in" class='facebook' rel='nofollow'><span class='square'><i class='fa fa-facebook'></i></span><span class='title'>Facebook</span></a> 
                                                                    <a target="_blank" href="http://twitter.com/share?text=An%20intersting%20blog&url=http://staging.foodlinked.co.in" class='twitter'  rel='nofollow'><span class='square'><i class='fa fa-twitter'></i></span><span class='title'>Twitter</span></a>
                                                                    <a target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url=http://staging.foodlinked.co.in" class='linkedin' rel='nofollow'><span class='square'><i class='fa fa-linkedin'></i></span><span class='title'>LinkedIn</span></a>
                                                                </div>
                                                            </div>
