                                    ...
                                    if (!empty($topicdata)) {
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 border-right-post">
                                                <form method="POST" action="<?php echo base_url('partner/hotel/add_posts/' . $topicdata['ct_key']); ?>" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-2">
                                                <form id="assignForm" method="POST" action="<?php echo base_url('partner/hotel/add_posts/' . $topicdata['ct_key']); ?>" enctype="multipart/form-data">
                                                    <input hidden="hidden" name="Hidden_User_Id" value="<?php echo $mPartnerId; ?>" />
                                                    <div class="post-card p-4 text-center">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="comment-box p-3">
                                                                        <form id="comment_form_<?php echo $mPostKey; ?>" method="POST" enctype="multipart/form-data" action="<?php echo base_url('partner/hotel/add_comment/' . $mPostKey); ?>">
                                                                            <div class="row">
                                                                                <div class="col-md-9">
