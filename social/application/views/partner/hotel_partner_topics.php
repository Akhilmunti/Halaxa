                                        ...
                                        <div class="col-md-2 p-2">
                                            ...
                                            <div id="addTopic" class="modal fade" role="dialog">
                                                <div class="modal-dialog modal-lg">
                                                    <!-- Modal content-->
                                                    <form id="Form" method="POST" action="<?php echo base_url() . "partner/school/add_topic"; ?>" enctype="multipart/form-data">
                                    ...
                                    <div class="">
                                        <ul class="list-unstyled">
                                            ...
                                            foreach ($topics as $key => $topic) {
                                                $mPosts = $this->cp_model->getAllParentByTopicKey($topic['ct_key']);
                                                if (!empty($mPosts)) {
                                                    $posts = count($mPosts);
                                                    $mWhoPosted = $mPosts[0]['cp_posted_id'];
                                                    if ($mWhoPosted == 0) {
                                                        ...
                                                        $mDesignation = "Admin";
                                                        $mDate = $mPosts[0]['cp_date_added'];
                                                        $mContent = $mPosts[0]['cp_content'];
                                                        $mPostKey = $mPosts[0]['cp_key'];
                                                    } else {
                                                ...
                                                <li>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-11">
                                                            <a class="topic-name" href="<?php echo base_url('partner/hotel/actionCommunityPost/' . $topic['ct_key']); ?>"><?php echo $topic['ct_topic']; ?></a> <span class="topic-last-light ml-2">(<?php echo $posts; ?> Posts)</span>
