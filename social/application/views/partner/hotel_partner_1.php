                                            ...
                                            <div id="myTabContent" class="tab-content">
                                                <div role="tabpanel" class="tab-pane fade <?php echo $activemain; ?> in" id="tab_content1" aria-labelledby="home-tab"> 
                                                    <div class="light-back">
                                                        <form id="Form" method="POST" action="<?php echo base_url() . "partner/hotel/add_post"; ?>" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                                                ...
                                                                <li> 
                                                                    ...
                                                                    <div class="message_date">
                                                                        ...
                                                                        <?php if ($conversation['posted_id'] == $this->session->userdata('login_id')) { ?>
                                                                            <a href="<?php echo base_url("partner/hotel/delete_post/"); ?><?php echo $conversation['id']; ?>" class="date"><i class="fa fa-trash"></i></a>                                                                            
                                                                        <?php } ?>
                                                                    </div>
                                                                    <div class="message_wrapper">
                                                                        ...
                                                                        <?php } else { ?>
                                                                            <?php if (file_exists($checkFile)) { ?>
                                                                                <p class="url">
                                                                                    <a href="<?php echo base_url(); ?><?php echo $conversation['attachment']; ?>" download="download"> <?php echo $conversation['attachment']; ?> </a>
                                                                                </p>
                                                                            <?php } ?>
        ...
        <!--                                                                            <td><?php echo $rating['Name']; ?></td>-->
                                                                            ...
                                                                            <td>
                                                                                <?php if ($rating['status'] == 0) { ?>
                                                                                    <a href="<?php echo base_url('partner/hotel/publishRating/') . $rating['id']; ?>" class="btn btn-xs btn-dark">Publish</a>
                                                                                <?php } else { ?>
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="tab_content9" aria-labelledby="profile-tab">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-9">
                                                            <div class="light-back">
                                                                <form id="formThree" enctype="multipart/form-data" class="form-horizontal form-label-left" action="<?php echo base_url('partner/hotel/sendRatings'); ?>" method="post">
                                                                    <div class="row">
                                                                        <div class="col-md-12 col-xs-12">
                                                                            <div class="form-group">
