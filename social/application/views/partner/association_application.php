                        ...
                        <div class="col-md-12">
                            <div class="partner-card">
                                <div class="partner-card-header">
                                    <p>Association Application</p>
                                </div>
                            </div>
                            <div class="partner-card-content">
                                <form id="Form" method="POST" action="<?php echo base_url() . "partner/association/add_new"; ?>" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-4 partners-form">
                                            ...
                                            <input type="text" id="association_name" class="form-control form-control-sm" name="association_name" required 
                                                   value="<?php echo set_value('association_name'); ?>"/>
                                            <?php if (form_error('association_name')) { ?><span style="color: #E68F8F;"><?php echo form_error('association_name'); ?></span> <?php } ?>
                                        ...
                                        <div class="col-md-3 mx-auto">
                                            <input type="submit" value="Submit" class="btn btn-sm btn-block btn-dark">
                                        </div>
                                    </div>
                                </form>
                            </div>
