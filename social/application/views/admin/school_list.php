                                    ...
                                    <div class="col-md-12"> <!--<a href="#" class="btn btn-dark btn-sm" data-toggle="modal" data-target="#newlistModal">Create New List</a> -->
                                        ...
                                        <table class="data table table-striped no-margin table-responsive table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($school_list as $school) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url('admin/school/viewSchool/') . $school['S_Id']; ?>" class="btn btn-success btn-xs btn-block"><i class="fa fa-user"></i> View </a>
                                                            <a href="<?php echo base_url('admin/school/editSchool/') . $school['S_Id']; ?>" class="btn btn-success btn-xs btn-block"><i class="fa fa-user"></i> Edit </a>
                                                            <?php if ($school['Status'] == "1"): ?>
                                                                <a href="#" class="btn btn-success btn-xs btn-block"><i class="fa fa-user"></i> User Approved </a>
                                                                <a href="<?php echo base_url() . "admin/school/deleteSchool/" . $school['S_Id']; ?>" class="btn btn-danger btn-xs btn-block"><i class="fa fa-user"></i> Delete </a>
                                                                <a class="btn btn-danger btn-xs btn-block" data-toggle="modal" data-target="#myModalReject_<?php echo $school['S_Id']; ?>"><i class="fa fa-user"></i> Reject </a>  
                                                            <?php elseif ($school['Status'] == "2"): ?>
                                                                <a href="#" class="btn btn-danger btn-xs btn-block"><i class="fa fa-user"></i> User Rejected </a>
                                                            <?php else: ?>
                                                                <a href="<?php echo base_url() . "admin/school/statusAccept/" . $school['S_Id']; ?>" class="btn btn-info btn-xs btn-block"><i class="fa fa-user"></i> Approve </a>
                                                                <a href="<?php echo base_url() . "admin/school/deleteSchool/" . $school['S_Id']; ?>" class="btn btn-danger btn-xs btn-block"><i class="fa fa-user"></i> Delete </a>
                                                                <a class="btn btn-danger btn-xs btn-block" data-toggle="modal" data-target="#myModalReject_<?php echo $school['S_Id']; ?>"><i class="fa fa-user"></i> Reject </a>                                                            
                                                            <?php endif; ?>
                                                        </td>
                                            ...
                                            foreach ($school_list as $school) {
                                                ?>
                                                <!-- Modal -->
                                                <div id="myModalReject_<?php echo $school['S_Id']; ?>" class="modal fade" role="dialog">
                                                    <div class="modal-dialog">
                                                        <form id="inmailForm" method="POST" action="<?php echo base_url() . "admin/school/statusReject/" . $school['S_Id']; ?>" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                                            <!-- Modal content-->
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                                    <h4 class="modal-title">Rejection Reason(<?php echo $school['School_Name']; ?>)</h4>
                                                                </div>
