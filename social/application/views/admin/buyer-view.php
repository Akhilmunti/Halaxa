                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="x_panel">
                                            ...
                                            <div class="x_content">
                                                <form id="formThree" class="form-horizontal form-label-left" action="#" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            ...
                                                            ?>
                                                            <input disabled="" value="<?php echo $phone; ?>" id="phone" name="phone" type="text" class="form-control" placeholder="<?php echo $phonePlaceholder; ?>">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <input disabled="" value="<?php echo $userdata->Company_name; ?>" id="cname" name="cname" type="text" class="form-control" placeholder="Company Name">
                                                            <span class="form-error-message text-danger"><?php echo $this->session->flashdata('vendoraddress'); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <input disabled="" value="<?php echo $userdata->Company_brief; ?>" id="cname" name="cname" type="text" class="form-control" placeholder="Company Name">
                                                            <span class="form-error-message text-danger"><?php echo $this->session->flashdata('vendoraddress'); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <input disabled="" value="<?php echo $userdata->delivery_address; ?>" id="cname" name="cname" type="text" class="form-control" placeholder="Company Name">
                                                            <span class="form-error-message text-danger"><?php echo $this->session->flashdata('vendoraddress'); ?></span>
                                                        </div>
                                                    </div>
