...
<html lang="en">
    ...
    <?php
    if ($school_info) {
        $mSchoolName = $school_info['School_Name'];
        ...
        $mSchoolName = set_value('school_name');
            ...
            <div class="right_col" role="main">
                <div class="page-title">
                    ...
                    <!--                    <div class="title_right">
                                            <a href="<?= base_url("partner/school/getList"); ?>">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_content">
                                <div class="row">
                                    <form id="Form" method="POST" action="<?php echo base_url() . "partner/school/edit/" . $mId; ?>" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                        <div class="col-md-4 partners-form">
                                            <div class="title">
                                                <h4>Address</h4>
                                            </div>
                                            <label for="fullname">School Name * :</label>
                                            <input type="text" id="school_name" class="form-control" name="school_name" readonly 
                                            ...
                                            <input type="text" id="school_address" class="form-control" placeholder="Address" name="school_address" readonly value="<?php echo $mAddress; ?>"/>
                                            <?php if (form_error('school_address')) { ?><span style="color: #E68F8F;"><?php echo form_error('school_address'); ?></span> <?php } ?>
                                            <input type="text" id="school_location" placeholder="Location" class="form-control" name="school_location" readonly value="<?php echo $mLocation; ?>"/>
                                            ...
                                            <select disabled="" name="state" id="state-automplete" class="form-control" readonly>
                                                <?php
                                            ...
                                            <select disabled="" name="city" id="city-automplete" class="form-control" readonly="">
                                                <?php
                                                foreach ($city as $ci) {
                                                    if ($mCity == $ci['name']) {
                                            ...
                                            <input value="<?php echo $mZipCode ?>" type="number" id="pincode" class="form-control" name="pincode" readonly value="<?php echo set_value('pincode'); ?>"/>
                                        ...
                                        <div class="col-md-4 partners-form">
                                            ...
                                            <input readonly type="text" id="website" class="form-control" name="website" readonly value="<?php echo $mWebsite; ?>"/>
                                            ...
                                            <input readonly type="text" id="hyperlink" class="form-control" name="hyperlink" readonly value="<?php echo $mVideoUrl; ?>"/>
                                            ...
                                            <input type="text" id="overview" class="form-control" name="overview" readonly value="<?php echo $mOverview; ?>"/>
                                            ...
                                            <input readonly type="text" id="no_of_students" class="form-control" name="no_of_students" readonly value="<?php echo $mNoOfStudents; ?>"/>
                                            ...
                                            <textarea readonly class="form-control" id="group_description" name="group_description" rows="3" readonly><?php echo $mGD ?></textarea>
                                        ...
                                        <div class="col-md-4 partners-form">
                                            ...
                                            <input type="text" id="salutation" class="form-control" name="salutation" readonly value="<?php echo $mSalutation; ?>"/>
                                            <?php if (form_error('salutation')) { ?><span style="color: #E68F8F;"><?php echo form_error('salutation'); ?></span> <?php } ?>
                                            <label for="fullname">First Name * :</label>
                                            <input type="text" id="first_name" class="form-control" name="first_name" readonly value="<?php echo $mFirstName; ?>"/>
                                            <?php if (form_error('first_name')) { ?><span style="color: #E68F8F;"><?php echo form_error('first_name'); ?></span> <?php } ?>
                                            <label for="fullname">Last Name * :</label>
                                            <input type="text" id="last_name" class="form-control" name="last_name" readonly value="<?php echo $mLastName; ?>"/>
                                            <?php if (form_error('last_name')) { ?><span style="color: #E68F8F;"><?php echo form_error('last_name'); ?></span> <?php } ?>
                                            <label for="fullname">Role  *:</label>
                                            <select disabled="" id="role" name="role" class="form-control" readonly>
                                            ...
                                            <input type="email" id="email_id" class="form-control" name="email_id" readonly value="<?php echo $mEmail; ?>" readonly/>
                                            <?php if (form_error('email_id')) { ?><span style="color: #E68F8F;"><?php echo form_error('email_id'); ?></span> <?php } ?>
                                            <label for="fullname">Phone * :</label>
                                            <div class="clearfix"></div>
                                            <div class="col-md-4 no-padding">
                                                <select disabled="" id="contact_type" name="contact_type" class="form-control" readonly>
                                                    <option value="">Choose..</option>
                                            ...
                                            <div class="col-md-4">
                                                <input type="number" placeholder="Area code" id="area_code" class="form-control" name="area_code" readonly value="<?php echo $mPACode; ?>"/>
                                                <?php if (form_error('area_code')) { ?><span style="color: #E68F8F;"><?php echo form_error('area_code'); ?></span> <?php } ?>
                                            </div>
                                            <div class="col-md-4 no-padding">
                                                <input type="number" placeholder="Number" id="contact" class="form-control" name="contact" readonly value="<?php echo $mPhoneNo; ?>"/>
                                                <?php if (form_error('contact')) { ?><span style="color: #E68F8F;"><?php echo form_error('contact'); ?></span> <?php } ?>
                                            </div>
                                            <label for="fullname">Fax :</label>
                                            <div class="clearfix"></div>
                                            <div class="col-md-4 no-padding">
                                                <select disabled="" id="fax_type" name="fax_type" class="form-control" readonly>
                                                    <option value="">Choose..</option>
                                            ...
                                            <div class="col-md-4">
                                                <input type="number" placeholder="Area code" id="fax_area_code" class="form-control" name="fax_area_code" readonly value="<?php echo $mFACode; ?>"/>
                                                <?php if (form_error('fax_area_code')) { ?><span style="color: #E68F8F;"><?php echo form_error('fax_area_code'); ?></span> <?php } ?>
                                            </div>
                                            <div class="col-md-4 no-padding">
                                                <input type="number" placeholder="Number" id="fax_contact" class="form-control" name="fax_contact" readonly value="<?php echo $mFaxNo; ?>"/>
                                            ...
                                            foreach ($days as $key_a => $val_a) {
                                                ...
                                                foreach ($selectedc as $key_b => $val_b) {
                                                    if ($val_a == $val_b) {
                                                        echo "<input disabled='' checked type='checkbox' class='flat' name='best_day[]' id='best_day' value='" . $val_a . "'/> $val_a";
                                                        $found = true;
                                                    }
                                                }
                                                if (!$found)
                                                    echo "<input disabled='' type='checkbox' class='flat' name='best_day[]' id='best_day' value='" . $val_a . "'/> $val_a";
                                            }
                                            ?>
                                            <br>
                                            ...
                                            foreach ($time as $key_a => $val_a) {
                                                ...
                                                foreach ($selectedc as $key_b => $val_b) {
                                                    if ($val_a == $val_b) {
                                                        echo "<input disabled='' checked type='checkbox' class='flat' name='best_time[]' id='best_time' value='" . $val_a . "'/> $val_a";
                                                        $found = true;
                                                    }
                                                }
                                                if (!$found)
                                                    echo "<input disabled='' type='checkbox' class='flat' name='best_time[]' id='best_time' value='" . $val_a . "'/> $val_a";
                                            }
                                            ?>
                                        </div>
                                    </form>
