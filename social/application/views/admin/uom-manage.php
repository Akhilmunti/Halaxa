                            ...
                            <div class="row">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="x_panel">
                                            <div class="x_title">
                                                <h2>UoM management (<b><a href="<?php echo base_url() . "admin/uom/add-new" ?>">+ADD NEW</a></b>)</h2>
                                                <?php
                                                        ...
                                                        if (!empty($uoms)) {
                                                            foreach ($uoms as $uom) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="<?php echo base_url() . "admin/uom/edit/" . $uom['U_Id']; ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                                                                        <a onclick="return confirm('Are you sure?')" href="<?php echo base_url() . "admin/uom/delete/" . $uom['U_Id']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </button>
                                                                    </td>
                                                                </tr>
                                                                <?php
                                                            }
