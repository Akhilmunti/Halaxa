                                ...
                                <div class="row">
                                    <form id="Form" method="POST" action="<?php echo base_url() . "admin/hotel/edit/" . $mId; ?>" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                        <div class="col-md-4 partners-form">
                                            ...
                                            <input type="text" id="hotel_address" class="form-control" name="hotel_address" required 
                                            ...
                                            <input type="text" id="hotel_location" class="form-control" name="hotel_location" required 
                                            ...
                                            <input value="<?php echo $mCountry; ?>" class="form-control" name="hotel_country" id="loc-automplete" list="country">
                                            <datalist id="country">
                                            ...
                                            <select name="hotel_state" id="state-automplete" class="form-control" required>
                                                <?php
                                            ...
                                            <select name="hotel_city" id="city-automplete" class="form-control" required="">
                                                <?php
                                                foreach ($city as $ci) {
                                                    if ($mCity == $ci['name']) {
                                            ...
                                            <input type="number" id="hotel_postal" class="form-control" name="hotel_postal" required 
                                        ...
                                        <div class="col-md-4 partners-form">
                                            ...
                                            <select id="hotel_rating" class="form-control" name="hotel_rating" required>
                                            ...
                                            <!--                                            <label for="fullname">Rating Source * :</label>
                                                                                        <select id="hotel_source" class="form-control" name="hotel_source" required>
                                            ...
                                            <input type="number" id="hotel_rooms" class="form-control" name="hotel_rooms" required 
                                            ...
                                            <select id="hotel_type" class="form-control" name="hotel_type" required>
                                                <option value="">Choose..</option>
                                                <option value="1" <?php
                                                if ($mType == '1') {
                                                    echo 'selected';
                                            ...
                                            <input type="text" id="hotel_website" class="form-control" name="hotel_website" 
...
<!--                                            <label for="fullname">Contact Information *: <i>Use the person you want for sign-in and communication during onboarding, if you dont have a fax numbern just enter your phone number</i></label>
                                            <select id="hotel_contact" class="form-control" name="hotel_contact" required>
                                                <option value="">Choose..</option>
                                                <option value="1" <?php
                                        ...
                                        <div class="col-md-4 partners-form">
                                            ...
                                            <input type="text" id="hotel_firstname" class="form-control" name="hotel_firstname" 
                                            ...
                                            <input type="text" id="hotel_lastname" class="form-control" name="hotel_lastname" 
                                            ...
                                            <select id="hotel_role" class="form-control" name="hotel_role" required>
                                                <option value="">Choose..</option>
                                                <option value="1" <?php
                                                if ($mRole == '1') {
                                                    echo 'selected';
