            ...
            <div class="right_col" role="main">
                <div class="page-title">
                    <div class="title_left">
                        <h3>Hotel admin Application</h3>
                    </div>
<!--                    <div class="right">
                        <a href="<?php echo base_url() . "admin/hotel/getList"; ?>" class="btn btn-dark btn-small">View Applications</a>
                    </div>-->
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_content">
                                <div class="row">
                                    <form id="Form" method="POST" action="<?php echo base_url() . "admin/hotel/edit/" . $mId; ?>" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                        <div class="col-md-4 partners-form">
                                            <label for="fullname">Property Name * :</label>
                                            <input readonly="" type="text" id="property_name" class="form-control" name="property_name" required 
                                            ...
                                            <input readonly="" type="text" id="hotel_address" class="form-control" name="hotel_address" required 
                                            ...
                                            <input readonly="" type="text" id="hotel_location" class="form-control" name="hotel_location" required 
                                            ...
                                            <input readonly="" value="<?php echo $mCountry; ?>" class="form-control" name="hotel_country" id="loc-automplete" list="country">
                                            <datalist id="country">
                                            ...
                                            <select disabled="" readonly="" name="hotel_state" id="state-automplete" class="form-control" required>
                                                <?php
                                            ...
                                            <select disabled="" readonly="" name="hotel_city" id="city-automplete" class="form-control" required="">
                                                <?php
                                                foreach ($city as $ci) {
                                                    if ($mCity == $ci['name']) {
                                            ...
                                            <input readonly="" type="number" id="hotel_postal" class="form-control" name="hotel_postal" required 
                                            ...
                                            <input readonly="" type="file" id="logo" class="form-control" name="logo" 
                                        ...
                                        <div class="col-md-4 partners-form">
                                            ...
                                            <select disabled="" readonly="" id="hotel_rating" class="form-control" name="hotel_rating" required>
                                            ...
                                            <!--                                            <label for="fullname">Rating Source * :</label>
                                                                                        <select disabled="" id="hotel_source" class="form-control" name="hotel_source" required>
                                            ...
                                            <input readonly="" type="number" id="hotel_rooms" class="form-control" name="hotel_rooms" required 
                                            ...
                                            <select disabled="" readonly="" id="hotel_type" class="form-control" name="hotel_type" required>
                                                <option value="">Choose..</option>
                                                <option value="1" <?php
                                                if ($mType == '1') {
                                                    echo 'selected';
                                            ...
                                            <input readonly="" type="text" id="hotel_website" class="form-control" name="hotel_website" 
...
<!--                                            <label for="fullname">Contact Information *: <i>Use the person you want for sign-in and communication during onboarding, if you dont have a fax numbern just enter your phone number</i></label>
                                            <select disabled="" id="hotel_contact" class="form-control" name="hotel_contact" required>
                                                <option value="">Choose..</option>
                                                <option value="1" <?php
                                        ...
                                        <div class="col-md-4 partners-form">
                                            ...
                                            <input readonly="" type="text" id="hotel_firstname" class="form-control" name="hotel_firstname" 
                                            ...
                                            <input readonly="" type="text" id="hotel_lastname" class="form-control" name="hotel_lastname" 
                                            ...
                                            <select disabled="" readonly="" id="hotel_role" class="form-control" name="hotel_role" required>
                                                <option value="">Choose..</option>
                                                <option value="1" <?php
                                                if ($mRole == '1') {
                                                    echo 'selected';
                                            ...
                                            <input readonly="" type="text" id="hotel_email" class="form-control" name="hotel_email" 
                                            ...
                                            <div class="col-md-4">
                                                <input readonly="" type="number" placeholder="Area code" id="fax_area_code" class="form-control" name="fax_area_code" value="<?php echo $mFACode; ?>"/>
                                                <?php if (form_error('fax_area_code')) { ?><span style="color: #E68F8F;"><?php echo form_error('fax_area_code'); ?></span> <?php } ?>
                                            </div>
                                            <div class="col-md-4 no-padding">
                                                <input readonly="" type="number" placeholder="Number" id="fax_contact" class="form-control" name="fax_contact" value="<?php echo $mFaxNo; ?>"/>
                                            ...
                                            foreach ($time as $key_a => $val_a) {
                                                ...
                                                if (!$found)
                                                    echo "<inputdisabled='' type='checkbox' class='flat' name='best_time[]' id='best_time' value='" . $val_a . "'/> $val_a";
                                            }
                                            ?>
