                                                ...
                                                <form id="formThree" class="form-horizontal form-label-left" action="<?php echo base_url('admin/vendors/edit/') . $vendoryid; ?>" method="post">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <input disabled="" value="<?php echo $userdata->Name; ?>" id="name" name="name" type="text" class="form-control" placeholder="Name">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <input disabled="" value="<?php echo $userdata->Username; ?>" id="username" name="username" type="text" class="form-control" placeholder="Username">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <input disabled="" value="<?php echo $vendordata['comapany_name']; ?>" id="cname" name="cname" type="text" class="form-control" placeholder="Company Name">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <input disabled="" value="<?php echo $userdata->Address; ?>" id="vendoraddress" name="vendoraddress" type="text" class="form-control" placeholder="Vendor address">
                                                            <span class="form-error-message text-danger"><?php echo $this->session->flashdata('vendoraddress'); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <input disabled="" value="<?php echo $userdata->Phone; ?>" id="phone" name="phone" type="text" class="form-control" placeholder="Phone">
                                                            <span class="form-error-message text-danger"><?php echo $this->session->flashdata('vendoraddress'); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <input disabled="" value="<?php echo $userdata->Email; ?>" id="email" name="email" type="text" class="form-control" placeholder="Email">
                                                            <span class="form-error-message text-danger"><?php echo $this->session->flashdata('vendoraddress'); ?></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <input disabled="" value="<?php echo $vendordata['website']; ?>" id="brief" name="brief" type="text" class="form-control" placeholder="Brief">
                                                            <span class="form-error-message text-danger"><?php echo $this->session->flashdata('vendoraddress'); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <input disabled="" value="<?php echo $vendordata['contact_person']; ?>" id="language" name="language" type="text" class="form-control" placeholder="Language">
                                                            <span class="form-error-message text-danger"><?php echo $this->session->flashdata('vendoraddress'); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <select disabled="" class="form-control" name="categories" id="categories">
                                                                <option>
                                                                    <?php
                                                                    $selected = json_decode($vendordata['categories']);
                                                                    if (is_array($selected)) {
                                                                        foreach ($selected as $cat) {
                                                                            $category = $this->category_model->getCategoryById($cat);
                                                                            echo $category['Category'] . " " . ",";
                                                                        }
                                                                    } else {
                                                                        if (is_numeric($vendordata['categories'])) {
                                                                            $category = $this->category_model->getCategoryById($vendordata['categories']);
                                                                            echo $category['Category'];
                                                                        } else {
                                                                            echo $vendordata['categories'];
                                                                        }
                                                                    }
                                                                    ?>
                                                                </option>
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <select disabled="" name="subcategories" id="subcategories" class="form-control">
                                                                <option>
                                                                    ...
                                                                    if (is_array($selected)) {
                                                                        foreach ($selected as $cat) {
                                                                            $category = $this->subcategory_model->getSubCategoryById($cat);
                                                                            echo $category['Sub_Category'] . " " . ",";
                                                                        }
                                                                    } else {
                                                                        if (is_numeric($vendordata['scategories'])) {
                                                                            $category = $this->subcategory_model->getSubCategoryById($vendordata['scategories']);
                                                                            echo $category['Sub_Category'];
                                                                        } else {
                                                                            echo $vendordata['scategories'];
                                                                        }
                                                                    }
                                                                    ?>
                                                                </option>
