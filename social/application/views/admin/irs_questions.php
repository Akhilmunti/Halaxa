            ...
            <div class="right_col" role="main">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Question Template (<b><a href="<?php echo base_url() . "admin/IRSQuestions/add" ?>">+ADD NEW</a></b>)</h2>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($questions as $question) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if ($question['question_status'] == 1) { ?>
                                                                <a href="<?php echo base_url('admin/IRSQuestions/actionDisable/') . $question['question_key']; ?>" class="btn btn-xs btn-danger">Disable</a>
                                                            <?php } else { ?>
                                                                <a href="<?php echo base_url('admin/IRSQuestions/actionEnable/') . $question['question_key']; ?>" class="btn btn-xs btn-success">Enable</a>
                                                            <?php } ?>
                                                            <a onclick="return confirm('Are you sure?')" href="<?php echo base_url('admin/IRSQuestions/actionDelete/') . $question['question_key']; ?>" class="btn btn-xs btn-danger">Delete</a>
                                                        </td>
                                                    </tr>
                                                <?php }
                                                ?>
