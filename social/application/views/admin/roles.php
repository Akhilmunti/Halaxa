            ...
            <div class="right_col" role="main">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Roles (<b><a href="<?php echo base_url() . "admin/roles/add" ?>">+ADD NEW</a></b>)</h2>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($roles as $role) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $role['role_date_added'] ?></td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <?php if ($role['role_status'] == 1) { ?>
                                                                <a href="<?php echo base_url('admin/roles/actionDisable/') . $role['role_key']; ?>" class="btn btn-xs btn-danger">Disable</a>
                                                            <?php } else { ?>
                                                                <a href="<?php echo base_url('admin/roles/actionEnable/') . $role['role_key']; ?>" class="btn btn-xs btn-success">Enable</a>
                                                            <?php } ?>
                                                            <a onclick="return confirm('Are you sure?')" href="<?php echo base_url('admin/roles/actionDelete/') . $role['role_key']; ?>" class="btn btn-xs btn-danger">Delete</a>
                                                        </td>
                                                    </tr>
                                                <?php }
                                                ?>
