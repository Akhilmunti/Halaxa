                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="x_panel">
                                            ...
                                            <div class="x_content">
                                                <form id="formTwo" class="form-horizontal form-label-left" action="<?php echo base_url('admin/city/edit/') . $cityid; ?>" method="post">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">City Name*: </label>
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <input value="<?php echo $citydata['City']; ?>" id="cityname" name="cityname" type="text" class="form-control" placeholder="Type Name">
