                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="x_panel">
                                            ...
                                            <div class="x_content">
                                                <form id="formOne" class="form-horizontal form-label-left" action="<?php echo base_url('admin/sub-category/edit/') . $subcategoryid; ?>" method="post">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Subcategory Name*: </label>
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <input value="<?php echo $subcategorydata['Sub_Category']; ?>" id="subcatname" name="subcatname" type="text" class="form-control" placeholder="Type Name">
                                                            <span class="form-error-message text-danger"><?php echo $this->session->flashdata('subcatname'); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <select id="catname" name="catname" class="form-control">
                                                                ...
                                                                foreach ($categorydata as $catkey => $cat) {
                                                                    if ($subcategorydata['CT_Key'] == $cat['CT_Id']) {
                                                                        echo "<option value='" . $cat['CT_Id'] . "' selected>" . $cat['Category'] . "</option>";
                                                                    } else {
                                                            ...
                                                            <span class="form-error-message text-danger"><?php echo $this->session->flashdata('catname'); ?></span>
                                                        </div>
                                                    </div>
            ...
            $(document).ready(function () {
                $("#formOne").submit(function (e) {
                    ...
                    if (subcatname.length > 0) {
                        $('#subcatname + .form-error-message').html('');
                        e1 = true;
                    } else {
                        $('#subcatname + .form-error-message').html('Please enter valid data.');
                        e1 = false;
                    }
                    if (catname.length > 0) {
                        e2 = true;
