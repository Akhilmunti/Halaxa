                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="x_panel">
                                            ...
                                            <div class="x_content">
                                                <form enctype="multipart/form-data" id="formOne" class="form-horizontal form-label-left" action="<?php echo base_url('admin/blogs/edit/') . $blogId; ?>" method="post">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Blog Topic*: </label>
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <input value="<?php echo $itemdata['topic']; ?>" id="topic" name="topic" type="text" class="form-control" placeholder="Blog Topic">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <input value="<?php echo $itemdata['blog_by']; ?>" id="by" name="by" type="text" class="form-control" placeholder="Blog By">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <input value="<?php echo $itemdata['blog_description']; ?>" id="description" name="description" type="text" class="form-control" placeholder="Blog Description">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <input value="<?php echo $itemdata['attachment']; ?>" id="attachment" name="attachment" type="file" class="form-control" placeholder="Blog Attachment">
