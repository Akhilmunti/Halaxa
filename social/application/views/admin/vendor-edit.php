                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="x_panel">
                                            ...
                                            <div class="x_content">
                                                ...
                                                <form id="formThree" class="form-horizontal form-label-left" action="<?php echo base_url('admin/user/editVendorUser/') . $vendoryid; ?>" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <input value="<?php echo $userdata->Address; ?>" id="vendoraddress" name="vendoraddress" type="text" class="form-control" placeholder="Company address">
                                                            <span class="form-error-message text-danger"><?php echo $this->session->flashdata('vendoraddress'); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <input value="<?php echo $vendordata['website']; ?>" id="brief" name="website" type="text" class="form-control" placeholder="website">
                                                            <span class="form-error-message text-danger"><?php echo $this->session->flashdata('vendoraddress'); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <input value="<?php echo $vendordata['contact_person']; ?>" id="language" name="contact" type="text" class="form-control" placeholder="Contact Person">
                                                            <span class="form-error-message text-danger"><?php echo $this->session->flashdata('vendoraddress'); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
