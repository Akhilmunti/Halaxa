                                ...
                                <div class="row">
                                    <form id="Form" method="POST" action="<?php echo base_url() . "admin/association/actionEdit/" . $mId; ?>" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                        <div class="col-md-4 partners-form">
                                            ...
                                            <input type="text" id="association_name" class="form-control" name="association_name" required 
                                            ...
                                            <input type="number" id="pincode" class="form-control" name="pincode" required value="<?php echo $mZipCode ?>"/>
                                        ...
                                        <div class="col-md-4 partners-form">
                                            ...
                                            <input type="text" id="hyperlink" class="form-control" name="hyperlink" required value="<?php echo $mVideoUrl; ?>"/>
                                            ...
                                            <input type="text" id="no_of_students" class="form-control" name="no_of_students" required value="<?php echo $mNoOfStudents; ?>"/>
                                            ...
                                            <textarea class="form-control" id="group_description" name="group_description" rows="3" required><?php echo $mGd; ?></textarea>
                                        ...
                                        <div class="col-md-4 partners-form">
                                            ...
                                            <div class="col-md-4">
                                                <input type="number" placeholder="Area code" id="fax_area_code" class="form-control" name="fax_area_code" required value="<?php echo $mFACode; ?>"/>
                                                <?php if (form_error('fax_area_code')) { ?><span style="color: #E68F8F;"><?php echo form_error('fax_area_code'); ?></span> <?php } ?>
                                            </div>
                                            <div class="col-md-4 no-padding">
                                                <input type="number" placeholder="Number" id="fax_contact" class="form-control" name="fax_contact" required value="<?php echo $mFaxNo; ?>"/>
