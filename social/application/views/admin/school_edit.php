                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_content">
                                <div class="row">
                                    <form id="Form" method="POST" action="<?php echo base_url() . "admin/school/actionUpdate/" . $mId; ?>" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                        <div class="col-md-4 partners-form">
                                            ...
                                            <input type="text" id="school_address" class="form-control" placeholder="Address" name="school_address" value="<?php echo $mAddress; ?>"/>
                                            <?php if (form_error('school_address')) { ?><span style="color: #E68F8F;"><?php echo form_error('school_address'); ?></span> <?php } ?>
                                            <input type="text" id="school_location" placeholder="Location" class="form-control" name="school_location" value="<?php echo $mLocation; ?>"/>
                                            ...
                                            <select name="city" id="city-automplete" class="form-control">
                                                <?php
                                                foreach ($city as $ci) {
                                                    if ($mCity == $ci['name']) {
                                            ...
                                            <input value="<?php echo $mZipCode ?>" type="number" id="pincode" class="form-control" name="pincode" value="<?php echo set_value('pincode'); ?>"/>
                                        ...
                                        <div class="col-md-4 partners-form">
                                            ...
                                            <input type="text" id="hyperlink" class="form-control" name="hyperlink" value="<?php echo $mVideoUrl; ?>"/>
                                            ...
                                            <input type="text" id="overview" class="form-control" name="overview" value="<?php echo $mOverview; ?>"/>
                                            ...
                                            <input type="text" id="no_of_students" class="form-control" name="no_of_students" value="<?php echo $mNoOfStudents; ?>"/>
                                            ...
                                            <textarea class="form-control" id="group_description" name="group_description" rows="3"><?php echo $mGD ?></textarea>
                                        ...
                                        <div class="col-md-4 partners-form">
                                            ...
                                            <input type="text" id="salutation" class="form-control" name="salutation" value="<?php echo $mSalutation; ?>"/>
                                            <?php if (form_error('salutation')) { ?><span style="color: #E68F8F;"><?php echo form_error('salutation'); ?></span> <?php } ?>
                                            <label for="fullname">First Name * :</label>
                                            <input type="text" id="first_name" class="form-control" name="first_name" value="<?php echo $mFirstName; ?>"/>
                                            <?php if (form_error('first_name')) { ?><span style="color: #E68F8F;"><?php echo form_error('first_name'); ?></span> <?php } ?>
                                            <label for="fullname">Last Name * :</label>
                                            <input type="text" id="last_name" class="form-control" name="last_name" value="<?php echo $mLastName; ?>"/>
                                            ...
                                            <input type="email" id="email_id" class="form-control" name="email_id" value="<?php echo $mEmail; ?>"/>
                                            ...
                                            <div class="col-md-4">
                                                <input type="number" placeholder="Area code" id="area_code" class="form-control" name="area_code" value="<?php echo $mPACode; ?>"/>
                                                <?php if (form_error('area_code')) { ?><span style="color: #E68F8F;"><?php echo form_error('area_code'); ?></span> <?php } ?>
                                            </div>
                                            <div class="col-md-4 no-padding">
                                                <input type="number" placeholder="Number" id="contact" class="form-control" name="contact" value="<?php echo $mPhoneNo; ?>"/>
