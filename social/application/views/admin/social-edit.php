                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="x_panel">
                                            ...
                                            <div class="x_content">
                                                ...
                                                <form id="formThree" class="form-horizontal form-label-left" action="<?php echo base_url('admin/user/updateSocialUser/') . $userdata->User_Id; ?>" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            ...
                                                            ?>
                                                            <input value="<?php echo $phone; ?>" id="phone" name="phone" type="text" class="form-control" placeholder="<?php echo $phonePlaceholder; ?>">
                                                            <span class="form-error-message text-danger"><?php echo $this->session->flashdata('vendoraddress'); ?></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                                            <button type="submit" class="btn btn-success">Update Social Details</button>
                                                        </div>
                                                    </div>                                                    
                                                </form>
                                            </div>
