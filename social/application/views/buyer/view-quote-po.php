                                    ...
                                    <div class="x_content">
                                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                            <ul id="myTab1" class="nav nav-tabs bar_tabs left" role="tablist">
                                                <li role="presentation" class=""><a href="#tab_content11" id="home-tabb" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">RFQ Info</a>
                                                </li>
                                                ...
                                                <li role="presentation" class="active <?php echo $potab; ?>"><a href="#tab_content55" role="tab" id="po-tabb" data-toggle="tab" aria-controls="po" aria-expanded="false">PO</a>
                                                </li>
                                            </ul>
                                            <div id="myTabContent2" class="tab-content">
                                                <div role="tabpanel" class="tab-pane fade in" id="tab_content11" aria-labelledby="home-tab">
                                                    <div class="row">
...
<!--                                                    <div class="row">
                                                ...
                                                <div role="tabpane3" class="tab-pane active fade in" id="tab_content55" aria-labelledby="home-tab">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        if ($postatus == "0"):
                                                                            ...
                                                                            <th colspan="7">Vendor name : <a href="<?php echo base_url(); ?>buyer/Profile/profileDetails/<?php echo $rfq['vendor_name']; ?>" target="_blank"><?php echo $rfq['vendor_name']; ?> </a>
                                                                                <a data-toggle="modal" data-target="#myModalPoMail_<?php echo $rfq['id'] ?>" onclick="return confirm('Are you sure?')" class="label label-warning btn-xs">Issue PO</a>
                                                                            </th>
                                                                        <?php else: ?>
                                                                            <th colspan="7">Vendor name : <a href="<?php echo base_url(); ?>buyer/Profile/profileDetails/<?php echo $rfq['vendor_name']; ?>" target="_blank"><?php echo $rfq['vendor_name']; ?> </a> 
                ...
                if (!empty($quotedRfqById)) {
                    ...
                    foreach ($quotedRfqById as $key => $rfq) {
                        ...
                        <div id="myModalPoMail_<?php echo $rfq['id'] ?>" class="modal fade" role="dialog" data-backdrop="false">
                            <div class="modal-dialog">
                                <form id="rfqForm" method="POST" action="<?php echo base_url(); ?>buyer/received_quotes/issuePo/<?php echo $rfq['id']; ?>  " class="form-horizontal form-label-left" enctype="multipart/form-data">
                                    <!-- Modal content-->
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
