                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="theme-card p-3">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h4 class="theme-header-text">Received Quotations</h4>
                                        </div>
                                        <div class="col-md-12">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2 no-padding-filter">
                                                                <select name="rfq_status" class="form-control form-control-sm form-control-filter">
                                                                    <option selected="" disabled="" value="">Quotation Status</option>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <p class="table-p text-theme">
                                                                            <?php echo $rfq['Category']; ?>
                                                                        </p>
                                                                    </td>
                                                                    <td>
                                                                        <?php if ($negotiate == 1) { ?>
                                                                            <p class="table-p text-pending">
                                                                                under negotation 
                                                                            </p>                                                                            
                                                                        <?php } else { ?>
                                                                            <p class="table-p text-theme">
                                                                    ...
                                                                    <td>
                                                                        <div>
                                                                            <?php if ($negotiate == 0) { ?>
                                                                                <a title="Negotiate" href="#" data-toggle="modal" data-target="#myModalNegMail_<?php echo $rfq['id'] ?>" onclick="return confirm('Are you sure?')" class="mr-3 no-decoration">
                                                                                    <img height="15" src="<?php echo base_url('assets/halaxa_buyer/images/negotiate-icon.png'); ?>" />
                                                                                </a>
                                                                            <?php } ?>

                                                                            <a data-toggle="tooltip" title="Compare" href="<?php echo base_url() . "buyer/received_quotes/showCompare/" . $rfq['RFQ_Id']; ?>" class="mr-3 no-decoration">
                                                                                <img height="15" src="<?php echo base_url('assets/halaxa_buyer/images/compare-icon.png'); ?>" />
                                                                            </a>
                                                                            <a data-toggle="tooltip" title="Issue PO"  onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>buyer/received_quotes/issuePo/<?php echo $rfq['id']; ?>" class="mr-3 no-decoration">
                                                                                <img height="15" src="<?php echo base_url('assets/halaxa_buyer/images/issuepo-icon.png'); ?>" />
                                                                            </a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
