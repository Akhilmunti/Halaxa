                                    ...
                                    <div class="x_content">
                                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                            <ul id="myTab1" class="nav nav-tabs bar_tabs left" role="tablist">
                                                <li role="presentation" class=""><a href="#tab_content33" role="tab" id="pro-tabb" data-toggle="tab" aria-controls="pro" aria-expanded="false">Compare Quotes</a>
                                                </li>
                                                <li role="presentation" class="active"><a href="#tab_content44" role="tab" id="prod-tabb" data-toggle="tab" aria-controls="prod" aria-expanded="false">Negotiate</a>
                                                </li>
                                            ...
                                            <div id="myTabContent2" class="tab-content">
                                                <div role="tabpane3" class="tab-pane fade in" id="tab_content33" aria-labelledby="home-tab">  
                                                    <style>
                                                        .m_wrap{
                                                            width:100%;
                                                            height:auto;
                                                ...
                                                <div role="tabpane3" class="tab-pane fade active in" id="tab_content44" aria-labelledby="home-tab">
