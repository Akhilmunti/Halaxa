                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="theme-card p-3">
                                    <div class="row">
                                        <div class="col-md-9">
                                            <h4 class="theme-header-text">Request For Quotation</h4>
                                        </div>
                                        <div class="col-md-3">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="custom-control custom-checkbox">
                                                        <input <?php
                                                        if ($rfqdata['V_Public'] == 1) {
                                                            echo "checked";
                                                        }
                                                        ?> readonly="" type="checkbox" class="custom-control-input" id="select_all_sellers_view">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="seller-card p-3 text-center">
                                                        <a href="<?php echo base_url() . "buyer/rfq/reorder/" . $rfqdata['RFQ_Id']; ?>" class="btn btn-success">Re-request</a>
                                                        <a data-toggle="modal" data-target="#<?php echo $rfqdata['RFQ_Id']; ?>" href="#" class="btn btn-danger">View Sellers</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
