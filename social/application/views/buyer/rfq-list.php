                            ...
                            <div class="col-md-12">
                                <div class="theme-card p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <form method="POST" action="<?php echo base_url('buyer/rfq'); ?>">
                                                    ...
                                                    <div class="col-md-11">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2 offset-3">
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <a href="<?php echo base_url('buyer/rfq'); ?>"><b class="font-size-11 p-info">Clear</b></a>
                                                                    </div>
                                                                    <div class="col-md-9">
                                    ...
                                    <form method="POST" action="<?php echo base_url('buyer/rfq/bulkAction'); ?>">
                                        <div class="row">
