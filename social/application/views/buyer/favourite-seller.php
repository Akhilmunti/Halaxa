                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="theme-card p-3">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h4 class="theme-header-text">Favourite Sellers</h4>
                                        </div>
                                        <div class="col-md-12">
                            ...
                            <div class="col-md-12 mt-2">
                                <form id="productForm" method="POST" action="<?php echo base_url() . "buyer/favourite_seller/sendBulkInmail"; ?>" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                    <div class="theme-card p-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    if (!empty($quotedRfq)) {
                                                        $iter = 0;
                                                        foreach ($quotedRfq as $key => $fav) {
                                                            $iter++;
                                                            $vendor = $this->vendor_model->get_elementvendor_byID($fav['vendor_id']);
                                                            $mStatus = $this->vendor_model->getFavourite($fav['vendor_id']);
