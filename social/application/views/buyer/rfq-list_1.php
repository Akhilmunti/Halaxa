                                                    ...
                                                    foreach ($rfqs as $key => $rfq) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a data-toggle="modal" data-target="#<?php echo $rfq['RFQ_Id']; ?>" href="" class="btn btn-info btn-xs">Vendors</a>
                                                                <a href="<?php echo base_url() . "buyer/rfq/cancelRfq/" . $rfq['RFQ_Id']; ?>" class="btn btn-danger btn-xs">Cancel RFQ</a>
        <!--                                                                <button onclick="share_rfq(<?php echo $rfq['RFQ_Id']; ?>);" type="button" class="btn btn-success btn-xs">Share</button>-->
                                    ...
                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($vendors as $key => $vendor) {
                                                ...
                                                echo "<tr><td>" . $i . "</td><td>" . $vendor->comapany_name . "</td></tr>";
                                            }
                                            ?>
                                            <tr>
