...
<div class="top_nav">
    <div class="nav_menu">
        <nav style="width: 100%;text-align: center;background-color: #2A3F54"> 
            ...
            <ul id="socialNav" class="nav navbar-nav" style="float: none;display: inline-block;">
                <li role="presentation"> <a href="<?php echo base_url(); ?>social/network" class="info-number" aria-expanded="false">My Network</a> </li>
                ...
                <li> <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    ...
                    <?php if ($this->session->userdata('User_Id')) {
                        ...
                        <ul class="dropdown-menu dropdown-usermenu pull-right">
                            <li><a href="<?php echo base_url("profile/professional"); ?>"> Profile</a></li>
                        ...
                        if (!empty($inmailMessages)) {
                            foreach (array_slice($inmailMessages, 0, 5) as $key => $message) {
                                ...
                                <?php if ($message['flag'] == "0") { ?>
                                    <li> 
                                        <a> <span class="image"
                                                  ><img src="<?php echo base_url(); ?>assets/images/favi.jpg" alt="Profile Image" /></span> 
