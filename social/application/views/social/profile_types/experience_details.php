<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <a data-toggle="modal" data-target=".bs-example-modal-Experience" class="btn btn-sm btn-success" style="float: right"><i class="fa fa-plus"></i> Add Experience</a>
    ...
    <div id="collapse2" class="panel-collapse collapse in">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <table class="table-striped table table-responsive">
                                <tbody>
                                    <tr>
                                        <td>
                                            Current Position : <?php echo $exp['designation'] ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Employment Type : <?php echo $exp['employment_type'] ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            About Company  : <?php echo $exp['about_company'] ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Role Description and Achievements : <?php echo $exp['role_description'] ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Year from : <?php echo $exp['yearfrom'] ?>
                                    </tr>
                                </tbody>
                            </table> 
                        </div>
                        <div class="col-md-6">
                            <table class="table-striped table table-responsive">
                                <tbody>
                                    <tr>
                                        <td>Year to : <?php echo $exp['yearto'] ?>
                                    </tr> 
                                    <tr>
                                        <td>Current Package : <?php echo $exp['package'] ?>
                                    </tr>
                                    <tr>
                                        <td>Key Responsibilities : <?php echo $exp['key_responsibilities'] ?>
                                    </tr>
                                    <tr>
                                        <td>Nationality : <?php echo $exp['company_nationality'] ?>
                                    </tr>
                                    <tr>
                                        <td>Company location : <?php echo $exp['company_location'] ?>
                                    </tr>
                                </tbody>
                            </table> 
                        </div>
        ...
        <!-- Experience modal -->
        <div class="modal fade bs-example-modal-Experience" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea id="editor3" name="about_company" class="form-control" required=""></textarea>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea id="editor4" name="role_description" class="form-control" required=""></textarea>
                                </div>
                            </div>                                                          
                            <div class="row">
                                <div class="form-group col-md-6">
