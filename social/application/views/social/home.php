...
<html lang="en">
    ...
    <!--                                                    <input placeholder="Write a post on Halaxa" required="" name="content" class="form-control comment-form"/>
                                                            ...
                                                            <div class="col-md-12 mt-3">
                                                                <div class="post-anchors">
                                                                    <?php if ($status[0]['status'] == "") { ?>
                                                                        <a onclick="likePost(<?php echo $val->P_ID; ?>, '1');" class="mr-2 no-decoration">
                                                                            <img id="like_img_<?php echo $val->P_ID; ?>" class="img-fluid post-time-img" src="<?php echo base_url('assets/halaxa_dashboard/images/post-heart-icon.png'); ?>" />
                                                                            <span id="like_count_<?php echo $val->P_ID; ?>" class="post-anchors-text mr-3"><?php echo $val->count; ?></span>
                                                                        </a>
                                                                    ...
                                                                    <?php } else { ?>
                                                                        <a onclick="likePost(<?php echo $val->P_ID; ?>, '0');" class="mr-2 no-decoration">
                                                                            <img id="like_img_<?php echo $val->P_ID; ?>" class="img-fluid post-time-img" src="<?php echo base_url('assets/halaxa_dashboard/images/post-heart-active-icon.png'); ?>" />
                                                                            <span id="like_count_<?php echo $val->P_ID; ?>" class="post-anchors-text mr-3"><?php echo $val->count; ?></span>
                                                                        </a>
                                                                    <?php } ?>
                                                                                            ...
                                                                                            foreach ($comments as $key => $com) {
                                                                                                ...
                                                                                                <?php } else { ?>
                                                                                                    ...
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        <div class="col-md-5 text-right">
                                                                                                            <a onclick="likeComment(<?php echo $com['C_Id']; ?>, '1');" class="mr-2 no-decoration">
                                                                                                                <?php if ($mCommentStatus[0]['Status'] == ""): ?>
                                                                                                                    <img id="like_comment_<?php echo $com['C_Id']; ?>" class="img-fluid post-time-img" src="<?php echo base_url('assets/halaxa_dashboard/images/post-heart-icon.png'); ?>" />
                                                                                                                <?php elseif ($mCommentStatus[0]['Status'] == "0"): ?>
                                                                                                                    <img id="like_comment_<?php echo $com['C_Id']; ?>" class="img-fluid post-time-img" src="<?php echo base_url('assets/halaxa_dashboard/images/post-heart-icon.png'); ?>" />
                                                                                                                <?php else: ?>
                                                                                                                    <img id="like_comment_<?php echo $com['C_Id']; ?>" class="img-fluid post-time-img" src="<?php echo base_url('assets/halaxa_dashboard/images/post-heart-active-icon.png'); ?>" />
                                                                                                                <?php endif; ?>
                                                                                                                <span id="count_comment_<?php echo $com['C_Id']; ?>" class="post-anchors-text mr-3"><?php echo $com['comment_likes_count']; ?></span>
                                                                                                            </a>
                                ...
                                <div class="theme-card p-3 mb-3">
                                    ...
                                    foreach ($userstoconnect as $key => $value) {
                                        ...
                                        <div class="row pt-2">
                                            <div class="col-md-2">
                                                <?php
                                                $mProImg = base_url('assets/photo/') . $value->Photo;
                                                if (file_exists($mProImg)) {
                                                    ?>
                                                    <img src="<?php echo base_url(); ?>assets/photo/<?php echo $value->Photo; ?>" class="img-fluid rounded-circle" alt="Avatar">
                                                <?php } else { ?>
                                                    <img class="img-fluid rounded-circle" src="<?php echo base_url(); ?>assets/images/user.png" />
                                                <?php } ?>
                                            </div>
                                            ...
                                            <div class="col-md-5 text-center">
                                                <a class="btn btn-sm btn-light" href="<?php echo base_url('social/request/Connected/') . $value->User_Id; ?>"> <span class="fa fa-plus mr-1"></span> Follow</a>
                                            </div>
                                        </div>
                                        <hr class="hr-theme">
                                    <?php } ?>
        ...
        <script type="text/javascript">
            ...
            function likePost(element, imageid) {
                if (element) {
                    $.post("<?php echo base_url('social/likePostDynamic/'); ?>" + element,
                            {
                                post_id: element
                            },
                            function (data, status) {
                                var resultarray = JSON.parse(data);
                                var likescount = resultarray['count'];
                                var likestatus = resultarray['status'];
                                if (likestatus === 1) {
                                    $('#like_count_' + element).html(likescount);
                                    $('#like_img_' + element).attr('src', '<?php echo base_url('assets/halaxa_dashboard/images/post-heart-active-icon.png'); ?>');
                                } else {
                                    $('#like_count_' + element).html(likescount);
                                    $('#like_img_' + element).attr('src', '<?php echo base_url('assets/halaxa_dashboard/images/post-heart-icon.png'); ?>');
                                }
                            });
                }
            }

            function likeComment(element, imageid) {
                if (element) {
                    $.post("<?php echo base_url('social/likeCommentDynamic/'); ?>" + element,
                            {
                                post_id: element
                            },
                            function (data, status) {
                                if (data === 0) {
                                    ...
                                    if (imageid === "1") {
                                        $('#count_comment_' + element).html(data);
                                        $('#like_comment_' + element).attr('src', '<?php echo base_url('assets/halaxa_dashboard/images/post-heart-active-icon.png'); ?>');
                                    } else if (imageid === "1") {
                                        $('#count_comment_' + element).html(data);
                                        $('#like_comment_' + element).attr('src', '<?php echo base_url('assets/halaxa_dashboard/images/post-heart-active-icon.png'); ?>');
                                    } else if (imageid === "0") {
                                        $('#count_comment_' + element).html(data);
                                        $('#like_comment_' + element).attr('src', '<?php echo base_url('assets/halaxa_dashboard/images/post-heart-icon.png'); ?>');
                                    }
