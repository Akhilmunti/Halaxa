                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="" id="tabs" role="tabpanel" data-example-id="togglable-tabs">
                                            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                                <li id="register" role="presentation" class="active"><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Register</a> </li>
                                            </ul>
                                            <div id="myTabContent" class="tab-content">
                                                ...
                                                if (isset($picerror)) {
                                                    ?>
                                                    <h5 style="text-align:center;background:red;color:white;font:bold"><?php echo "Registration not successfull" . $error['error']; ?></h5>
                                                <?php }
                                                ?>
                                                        ...
                                                        <div class="omb_login">
                                                            ...
                                                            <div class="row omb_row-sm-offset-3">
                                                                <div class="col-xs-12 col-sm-6">
                                                                    ...
                                                                    <form  action="<?php echo base_url('login/addIntern/') ?><?php echo $partnerId; ?>" method="post" enctype="multipart/form-data">

                                                                        <?php if (form_error('Name')) { ?><span class="form-error-message text-danger"><?php echo form_error('Name'); ?></span>
                                                                        <?php } ?>
