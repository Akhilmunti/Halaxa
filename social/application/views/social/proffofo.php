...
<html>
    <head>
        ...
        <!-- Bootstrap 3.3.7 -->
        <link rel="stylesheet" href="https://foodlinked.com/irs/public/External/bower_components/bootstrap/dist/css/bootstrap.min.css">
        <!-- Bootstrap 3.3.7 -->
        <link rel="stylesheet" href="https://foodlinked.com/irs/public/External/bower_components/bootstrap/dist/css/bootstrap.css">
        <!-- Font Awesome -->
                ...
                <div class="col-md-3 left_col menu_fixed">
                    <div class="left_col scroll-view">
                        <div class="navbar nav_title" style="border: 0;">
                            <a href="https://foodlinked.com/irs" class="site_title"><i class="fa fa-paw"></i> <span>Foodlinked</span></a>
                        </div>
                        ...
                        <div class="profile clearfix">
                            <div class="profile_pic">
                                <img src="https://foodlinked.com/social//assets/images/user.png " alt="..." class="img-circle profile_img">
                            </div>
                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            <div class="menu_section">
                                ...
                                <li><a href=""><i class="fa fa-edit"></i>Profile</a>
                                </li> -->
                                    <li><a href="https://foodlinked.com/irs/job_seeker/apply_job"><i class="fa fa-bar-chart-o"></i> Apply for job</a>
                                    </li>
                                    <li><a href="https://foodlinked.com/irs/job_seeker/job_history"><i class="fa fa-table"></i> Apply job History</a></li>
                                    <li><a href="https://foodlinked.com/irs/job_seeker/job_preferences"><i class="fa fa-briefcase"></i>Job Preferences</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="sidebar-footer hidden-small">
                            ...
                            <a data-toggle="tooltip" data-placement="top" title="Logout" href="https://foodlinked.com/irs/auth/logout" onclick="event.preventDefault();
        document.getElementById('logout-form').submit();"><span class="glyphicon glyphicon-off" aria-hidden="true"></span></a>
                            <form id="logout-form" action="https://foodlinked.com/irs/auth/logout" method="POST" style="display: none;">
                                <input type="text" value='9yhwaCJSMcNvveRPD7S3wJUlTuOWdChguAMBnzIn' name='_token'>
                            </form>
                    ...
                    <div class="nav_menu">
                        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li role="presentation"> <a href="https://foodlinked.com/irs/employer/" class="info-number" aria-expanded="false">Recruit</a></li>

                                <li role="social-nav-active"> <a href="https://foodlinked.com/social/buyer" class="info-number" aria-expanded="false">Buy </a></li>

                                <li class="presentation"> <a href="https://foodlinked.com/social/vendor" class="info-number" aria-expanded="false">Sell </a></li>



                                <li> <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> 
                                        <img src="https://foodlinked.com/social//assets/images/user.png " alt="..." >
                                    ...
                                    <ul class="dropdown-menu dropdown-usermenu pull-right">
                                        ...
                                        <li><a href="https://foodlinked.com/irs/home/profile"> Profile</a></li>

                                        <li><a  href="https://foodlinked.com/irs/auth/logout"
                                        ...
                                        <!-- <li><a href="https://foodlinked.com/irs/auth/logout" onclick="event.preventDefault();
            
                                             document.getElementById('logout-form').submit();">Logout</a>
            
                                             <form id="logout-form" action="https://foodlinked.com/irs/auth/logout" method="POST" style="display: none;"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li> -->
                                ...
                                <li role="presentation"> <a href="https://foodlinked.com/irs/job_seeker" class="info-number" aria-expanded="false">Jobs </a> </li>

                                <li role="presentation"> <a href="https://foodlinked.com/social/communities/buyerCommmunity" class="info-number" aria-expanded="false">Communities</a> </li>

                                <li role="presentation"> <a href="https://foodlinked.com/social/social/network" class="info-number" aria-expanded="false">My Network</a> </li>

                                <li role="presentation"> <a href="https://foodlinked.com/social/social" class="info-number" aria-expanded="false">My Wall </a> </li>
            ...
            <!-- /top navigation -->        <div class="right_col" role="main" >
                            ...
                            <div class="card wizard-card" data-color="orange" id="wizardProfile"> 
                                ...
                                <div class="row">
                                            ...
                                            <table class="table table-striped">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="col-md-8">Tourism and Travel Management</td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row" class="col-md-4">Country
                                                        </th>
                                    ...
                                    <div class="col-md-1 pull-right">
                                        <button class="btn btn-success btn-sm pull-right"   onClick="opendeditqualificationmodel('3f5a03c8-5bcd-463b-acc6-fa8c770d00ec');"   data-toggle="modal" data-target="#edit_qualification_div" type="button"  title="Add Education" style="margin-top:5px;"><i class="glyphicon glyphicon-edit "></i> </a></button>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="card wizard-card" id="wizardProfile">
        <form action="https://foodlinked.com/irs/home/editjobseekerpersonalprofile" method="post" id="personaldetail">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type = "hidden" name="_token" value="9yhwaCJSMcNvveRPD7S3wJUlTuOWdChguAMBnzIn">
                                        <label for="">Name 
                                            <span class="requerd">* 
                                            </span>
                                        </label>
                                        <input type="text" class="form-control"  name="name" id="name" placeholder="Name" value="akhilmunti" required>
                                        <div id="name-error">
                                        </div>
                                    </div> 
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email" placeholder="Email" value="akhilmunti@gmail.com" required readonly>
                                        <div id="email-error">
                                        </div>
                                    </div> 
                                    <div class="form-group">
    ...
    <script src="https://foodlinked.com/irs/public/External/pnotify/tost/toast.js"></script>

    <script src="https://foodlinked.com/irs/public/External/pnotify/tost/toaster.js"></script>
                        ...
                        $(document).ready(function () {
                            ...
                            $('.crop_image').click(function (event) {
                                $image_crop.croppie('result', {
                                    ...
                                    $.ajax({
                                        url: "https://foodlinked.com/irs/common/uploadJsImg",
                                        type: "POST",
                                        data: {"image": response, _token: '9yhwaCJSMcNvveRPD7S3wJUlTuOWdChguAMBnzIn'},
    ...
    <script>
        function ShowState(option) {
            ...
            $.ajax({
                type: "post",
                url: "https://foodlinked.com/irs/common/showstatewithoption",
                data: {
                    Country: Country, option: option, "_token": '9yhwaCJSMcNvveRPD7S3wJUlTuOWdChguAMBnzIn'}
                ,
    ...
    <script>
        function ShowCity(option) {
            ...
            $.ajax({
                type: "post",
                url: "https://foodlinked.com/irs/common/showcitywithoption",
                data: {
                    State: State, option: option, "_token": '9yhwaCJSMcNvveRPD7S3wJUlTuOWdChguAMBnzIn'}
                ,
                context: document.body
            }
            ).done(function (msg) {
    ...
    <script>
        function ShowCourse(op_type) {
            ...
            $.ajax({
                type: "post",
                url: "https://foodlinked.com/irs/common/showcourse",
                data: {
                    typeofeducation: typeofeducation, op_type: op_type, "_token": '9yhwaCJSMcNvveRPD7S3wJUlTuOWdChguAMBnzIn'}
                ,
                context: document.body
            }
            ).done(function (msg) {
    ...
    <script>
        function opendeditqualificationmodel(qualificationid) {
            $.ajax({
                type: "post",
                url: "https://foodlinked.com/irs/home/opendeditqualificationmodel",
                data: {qualificationid: qualificationid, "_token": '9yhwaCJSMcNvveRPD7S3wJUlTuOWdChguAMBnzIn'}
                ,
                context: document.body
            }
            ).done(function (msg) {
        ...
        function openjsexperienceeditmodel(experienceid) {
            $.ajax({
                type: "post",
                url: "https://foodlinked.com/irs/home/openjsexperienceeditmodel",
                data: {experienceid: experienceid, "_token": '9yhwaCJSMcNvveRPD7S3wJUlTuOWdChguAMBnzIn'}
                ,
                context: document.body
            }
            ).done(function (msg) {
        ...
        function openjseditprojectdetailmodel(projectid) {
            $.ajax({
                type: "post",
                url: "https://foodlinked.com/irs/home/openjseditprojectdetailmodel",
                data: {projectid: projectid, "_token": '9yhwaCJSMcNvveRPD7S3wJUlTuOWdChguAMBnzIn'}
                ,
                context: document.body
            }
            ).done(function (msg) {
        ...
        function openjseditCertificatedetailmodel(certificateid) {
            $.ajax({
                type: "post",
                url: "https://foodlinked.com/irs/home/openjseditcertificatedetailmodel",
                data: {certificateid: certificateid, "_token": '9yhwaCJSMcNvveRPD7S3wJUlTuOWdChguAMBnzIn'}
                ,
                context: document.body
            }
            ).done(function (msg) {
    ...
    <script>
        function ShowStream(op_type) {
            ...
            $.ajax({
                type: "post",
                url: "https://foodlinked.com/irs/common/showstream",
                data: {
                    typeofeducation: typeofeducation, courseName: courseName, "_token": '9yhwaCJSMcNvveRPD7S3wJUlTuOWdChguAMBnzIn'}
                ,
                context: document.body
            }
            ).done(function (msg) {
