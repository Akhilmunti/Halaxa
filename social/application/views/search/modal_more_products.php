...
if (!empty($products)) {
    ...
    foreach ($products as $key => $product) {
        ...
        ?>
        <!-- Modal -->
        <div id="more_<?php echo $counterIds ?>" class="modal fade" role="dialog">
            <div class="modal-dialog">
                <?php
                $venProducts = $this->product_model->getProductsByUser($product['V_Id']);
                ?>
                <!-- Modal content-->
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="overflow-y: scroll;height: 400px">
                        <div class="row">
                            <?php
                            if (!empty($venProducts)) {
                                $counter = 0;
                                foreach ($venProducts as $key => $product) {
                                    $counter++;
                                    ?>
