    ...
    private function setSortedProfilePictures() {
        ...
        if (is_array($pictures)) {
            $pictures = array_filter($pictures, function ($element) {
                ...
                return
                        isset($element['data']['com.linkedin.digitalmedia.mediaartifact.StillImage']) && strtoupper($element['authorizationMethod']) === 'PUBLIC' && isset($element['identifiers'][0]['identifier'])
                ;
            });
