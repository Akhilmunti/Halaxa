...
define('URL_SOCIAL', 'http://localhost/Halaxa/social/');
define('URL_JOB', 'http://localhost/Halaxa/irs/');
...
define('FB_LOGIN_URL', 'https://www.foodlinked.com/social/socialauthentication/facebook');
define('FB_LOGOUT_URL', 'https://www.foodlinked.com/social/socialauthentication/fblogout');
...
define('GP_CLIENT_ID', '949757778087-7bhs8ku1ir1q9631rfciupfrn2emdbbh.apps.googleusercontent.com');
define('GP_CLIENT_SECRET', '9e7y616uqLBsQ8TpoZBAfow-');
define('GP_REDIRECT_URI', 'https://www.foodlinked.com/social/socialauthentication/google');
...
define('LIN_REDIRECT_URL', 'https://www.foodlinked.com/social/socialauthentication/linkedin');
define('LIN_SCOPE', 'r_liteprofile r_emailaddress');

/* Linkedin Credentials End */

define('PROJECT_NAME', "Halaxa");