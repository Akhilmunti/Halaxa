                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a target="_blank" class="nav-link" href="<?php echo base_url("social/home/jobs"); ?>">JOBS</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col offset-md-2 col-md-3 col-xs-12 justify-content-center btns-section-one">
                                <div class="sidebar">
                                    ...
                                    <a href="<?php echo base_url("social/home/jobs"); ?>" class="opt--a" target="_blank">
                                        <div class="opt">
                                            <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                                    ...
                                    <a href="<?php echo base_url("social/home/recruit"); ?>" class="opt--a" target="_blank">
                                        <div class="opt">
                                            <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                        ...
                        <div class="col-md-15 col-xs-12">
                            <div class="card shadow">
                                <div class="card-body text-center">
                                    <a class="text-uppercase" href="<?php echo base_url(); ?>social/home/network" target="_blank">Network</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-15 col-xs-12">
                            <div class="card shadow">
                                <div class="card-body text-center">
                                    <a class="text-uppercase" href="<?php echo base_url(); ?>social/home/jobs" target="_blank">Find a job</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-15 col-xs-12">
                            <div class="card shadow">
                                <div class="card-body text-center">
                                    <a class="text-uppercase" href="<?php echo base_url(); ?>social/home/recruit" target="_blank">Post a job</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-15 col-xs-12">
                            <div class="card shadow">
                                <div class="card-body text-center">
                                    <a class="text-uppercase" href="<?php echo base_url(); ?>social/home/sell" target="_blank">Sell products</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-15 col-xs-12">
                            <div class="card shadow">
                                <div class="card-body text-center">
                                    <a class="text-uppercase" href="<?php echo base_url(); ?>social/home/buy" target="_blank">Buy products</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col col-md-12 col-xs-12 section-three-menu">
                                ...
                                <div class="row mt-3 mb-3">
                                    <div class="col col-md-3 text-center">
                                        <a target="_blank" href="<?php echo base_url(); ?>social/home/network" class="btn btn-outline-secondary btn-block">One Click Apply</a>
                                    </div>
                                    <div class="col col-md-3 text-center">
                                        <a target="_blank" href="<?php echo base_url(); ?>social/home/network" class="btn btn-outline-secondary btn-block">Browse Jobs</a>
                                    </div>
                                    <div class="col col-md-3 text-center">
                                        <a target="_blank" href="<?php echo base_url(); ?>social/home/network" class="btn btn-outline-secondary btn-block">Hire the best talent</a>
                                    </div>
                                    <div class="col col-md-3 text-center">
                                        <a target="_blank" href="<?php echo base_url(); ?>social/home/network" class="btn btn-outline-secondary btn-block">Reduce Time & Effort</a>
                                    </div>
                                </div>
                                <div class="row mt-3 mb-3">
                                    <div class="col col-md-3 text-center">
                                        <a target="_blank" href="<?php echo base_url(); ?>social/home/network" class="btn btn-outline-secondary btn-block">Set your preference</a>
                                    </div>
                                    <div class="col col-md-3 text-center">
                                        <a target="_blank" href="<?php echo base_url(); ?>social/home/network" class="btn btn-outline-secondary btn-block">Track your applications</a>
                                    </div>
                                    <div class="col col-md-3 text-center">
                                        <a target="_blank" href="<?php echo base_url(); ?>social/home/network" class="btn btn-outline-secondary btn-block">Save money</a>
                                    </div>
                                    <div class="col col-md-3 text-center">
                                        <a target="_blank" href="<?php echo base_url(); ?>social/home/network" class="btn btn-outline-secondary btn-block">Increase flexibility</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-3 col-xs-12 col-sm-12">
                                <h5>About Us</h5>
                                <ul class="list-unstyled">
                                    <li><a href="<?php echo base_url('social/home/aboutus'); ?>">What is FoodLinked ?</a></li>
                                    <li><a href="<?php echo base_url('social/home/story'); ?>">Our story</a></li>
                                    <li><a href="<?php echo base_url('social/home/values'); ?>">Values</a></li>
                                    <li><a href="<?php echo base_url('social/home/promise'); ?>">Our promise to you</a></li>
                                </ul>
                            </div>
                            <div class="col-lg-3 col-xs-12 col-sm-12">
                                <h5>Goto</h5>
                            ...
                            <div class="col-lg-3 col-xs-12 col-sm-12">
                                ...
                                <ul class="list-unstyled">
                                    <li><a target="_blank" href="https://www.facebook.com/foodlinked1">Facebook</a></li>
                                    <li><a target="_blank" href="https://twitter.com/foodlinked0031">Twitter</a></li>
                                    <li><a target="_blank" href="https://in.linkedin.com/company/foodlinked">Linkedin</a></li>
                                </ul>
                                <h5>Contact us</h5>
                                <ul class="list-unstyled">
