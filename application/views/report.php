        ...
        <div class="main">
            ...
            <section class="section-header">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="big-text mt-5">Report</h1>
                        </div>
                        ...
                        <form method="POST" action="#">
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <input required="" type="text" placeholder="Enter Name" class="form-control" name="" id=""  />
                                </div>
                                <div class="col-md-4 mb-3">
                                    <input required="" type="email" placeholder="Enter Email" class="form-control" name="" id=""  />
                                </div>
                                <div class="col-md-4 mb-3">
                                    <input required="" type="tel" placeholder="Enter Phone" class="form-control" name="" id=""  />
                                </div>
                                <div class="col-md-12 mb-2">
                                    <textarea placeholder="Enter Query" required="" class="form-control" rows="5"></textarea>
                                    <hr>
                                    <button class="btn btn-theme-submit btn-circle">Submit</button>
                                </div>
